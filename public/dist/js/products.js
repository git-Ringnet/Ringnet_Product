...
function addRowRepesent() {
    var tr = `
        <tr class="bg-white" id="dynamic-row-1">
            ...
            <td class="border border-top-0 border-left-0">
                <input type="text" name="represent_name[]" class="border-0 px-2 py-1 w-100" autocomplete="off"> 
            </td>
            <td class="border border-top-0 border-left-0">
                <input type="text" name="represent_phone[]" class="border-0 px-2 py-1 w-100">
            </td>
            <td class="border border-top-0 border-left-0">
                <input type="email" name="represent_email[]" class="border-0 px-2 py-1 w-100">
            </td>
            <td class="border border-top-0 border-left-0">
                <input type="text" name="represent_address[]" class="border-0 px-2 py-1 w-100">
            </td>
            <td class="border border-top-0 border-left-0 deleteRepesent">

    ...
    var tr = `
        <tr class="bg-white">
            ...
            <td class="border border-top-0">
                <input type="text" name="represent_name[]" class="border-0 px-3 py-2 w-75 w-100"> 
            </td>
            <td class="border border-left-0 border-top-0">
                <input type="text" name="represent_email[]" class="border-0 px-3 py-2 w-75 w-100">
            </td>
            <td class="border border-left-0 border-top-0">
                <input type="text" name="represent_phone[]" class="border-0 px-3 py-2 w-75 w-100">
            </td>
            <td class="border border-left-0 border-top-0">
                <input type="text" name="represent_address[]" class="border-0 px-3 py-2 w-75 w-100">
            </td>

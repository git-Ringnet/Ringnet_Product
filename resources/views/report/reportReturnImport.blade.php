                                        ...
                                        <div class="dropdown-menu" id="dropdown-menu"
                                            ...
                                            <div class="scrollbar">
                                                ...
                                                <button class="dropdown-item btndropdown text-13-black"
                                                    ...
                                                    phiếu</button>
                                                <button class="dropdown-item btndropdown text-13-black"
                                                    id="btn-provides" data-button="provides" type="button">Tên nhà
                                                    cung cấp</button>
                                                <button class="dropdown-item btndropdown text-13-black" id="btn-name"
                                                    data-button="name" type="button">Tên hàng hóa</button>
                                                ...
                                                <button class="dropdown-item btndropdown text-13-black"
                                                    id="btn-status" data-button="status" type="button">Trạng
                                                    thái</button>
                                            </div>
                                        </div>
                                        <!-- Input fields for filtering -->
                                        <x-filter-date-time name="date" title="Ngày" />
                                        <x-filter-text name="maphieu" title="Số phiếu" />
                                        <x-filter-text name="provides" title="Tên nhà cung cấp" />
                                        <x-filter-text name="name" title="Tên hàng hóa" />
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" class="height-52 border"
                                                    ...
                                                    <span class="d-flex justify-content-end">
                                                        <a href="#" class="sort-link"
                                                            data-sort-by="guest_name_display" data-sort-type="ASC">
                                                            <button class="btn-sort text-13" type="submit">Tên nhà
                                                                cung cấp
                                                            </button>
                                                        </a>
                                                        <div class="icon" id="icon-guest_name_display"></div>
...
<script>
    $(document).on('click', '.btn-submit', function(e) {
        ...
        var formData = {
            ...
            maphieu: getData('#maphieu', this), // Số phiếu
            provides: getData('#provides', this), // Tên nhà cung cấp
            name: getData('#name', this), // Tên hàng hóa

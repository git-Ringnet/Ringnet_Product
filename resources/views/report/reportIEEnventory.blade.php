                                        ...
                                        <div class="dropdown-menu" id="dropdown-menu"
                                            ...
                                            <div class="scrollbar">
                                                ...
                                                <button class="dropdown-item btndropdown text-13-black" id="btn-code"
                                                    data-button="code" type="button">Mã hàng
                                                </button>
                                                <button class="dropdown-item btndropdown text-13-black" id="btn-name"
                                                    data-button="name" type="button">Tên hàng
                                                </button>
                                                ...
                                                <button class="dropdown-item btndropdown text-13-black"
                                                    id="btn-import" data-button="import" type="button">Nhập
                                                </button>
                                                <button class="dropdown-item btndropdown text-13-black"
                                                    id="btn-export" data-button="export" type="button">Xuất
                                                </button>
                                                <button class="dropdown-item btndropdown text-13-black" id="btn-debt"
                                                    data-button="debt" type="button">Tồn cuối
                                                </button>
                                            </div>
                                        </div>

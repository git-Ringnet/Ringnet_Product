                        ...
                        <div class="dropdown-menu" id="dropdown-menu"
                            ...
                            <div class="scrollbar">
                                ...
                                <button class="dropdown-item btndropdown text-13-black"
                                    ...
                                    hàng</button>
                                <button class="dropdown-item btndropdown text-13-black"
                                    id="btn-dvt" data-button="dvt"
                                    type="button">ĐVT</button>
                                <button class="dropdown-item btndropdown text-13-black"
                                    id="btn-slban" data-button="slban" type="button">Số
                                    lượng
                                    bán</button>
                                <button class="dropdown-item btndropdown text-13-black"
                                    ...
                                    <div class="outer-4 top-table table-responsive text-nowrap">
                                        <table class="table table-hover">
                                            ...
                                            <tbody class="table-hanghoa">
                                                ...
                                                <tr>
                                                    <td colspan="12" class="border-bottom bold">Nhóm hàng hóa : Chưa
                                                        chọn nhóm
                                                    </td>
                                                </tr>
                                                ...
                                                @endforeach
                                                <tr class="bg-light">
                                                    <td colspan="6" class="text-right bold border text-green">Tổng
                                                        cộng:</td>
                                                ...
                                                @foreach ($groups as $value)
                                                    ...
                                                    <tr>
                                                        <td colspan="12" class="border-bottom bold">Nhóm hàng hóa :
                                                            {{ $value->name }}</td>
                                                    </tr>
                                                    ...
                                                    @endforeach
                                                    <tr class="bg-light">
                                                        <td colspan="6" class="text-right text-green border bold">
                                                            Tổng cộng:
                                                        </td>
                                    ...
                                    <div class="outer-4 top-table table-responsive text-nowrap">
                                        <table class="table table-hover">
                                            ...
                                            <tbody class="table-khachhang">
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="6" class="text-right text-green border bold">Tổng
                                                        cộng:</td>
                                                    <td class="height-52 text-green border bold">
                                                        {{ number_format($totalSlXuatUngrouped) }}</td>
                                                    <td class="height-52 text-green border bold">
                                                ...
                                                @foreach ($groupGuests as $value)
                                                    ...
                                                    <tr class="bg-light">
                                                        <td colspan="6" class="text-right text-green bold border">
                                                            Tổng cộng:</td>

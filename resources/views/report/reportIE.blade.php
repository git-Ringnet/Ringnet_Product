                                        ...
                                        <div class="dropdown mx-2 filter-all">
                                            ...
                                            <div class="dropdown-menu" id="dropdown-menu"
                                                ...
                                                <div class="scrollbar">
                                                    ...
                                                    <button class="dropdown-item btndropdown text-13-black btn-content"
                                                        id="btn-content" data-button="thu" type="content">Nội
                                                        dung thu
                                                        chi</button>
                                                    <button class="dropdown-item btndropdown text-13-black btn-amount"
                                                        id="btn-amount" data-button="thu" type="amount">Số
                                                        tiền</button>
                                                    <button class="dropdown-item btndropdown text-13-black btn-fund"
                                                        id="btn-fund" data-button="fund" type="button">Quỹ</button>
                                                    <button class="dropdown-item btndropdown text-13-black btn-note"
                                ...
                                <div class="col-md-5 d-flex align-items-center">
                                    ...
                                    <div class="dropdown mx-2 filter-al">
                                        ...
                                        <div class="dropdown-menu" id="dropdown-menu"
                                            ...
                                            <div class="scrollbar">
                                                <button class="dropdown-item btndropdownn text-13-black btn-date_chi"
                                                ...
                                                <button class="dropdown-item btndropdownn text-13-black btn-name_chi"
                                                    id="btn-name_chi" data-button="name_chi"
                                                    type="button">Tên</button>
                                                <button
                                                    class="dropdown-item btndropdownn text-13-black btn-content_chi"
                                                    id="btn-content_chi" data-button="content_chi" type="button">Nội
                                                    dung chi</button>
                                                <button class="dropdown-item btndropdownn text-13-black btn-total_chi"
                                                    id="btn-total_chi" data-button="total_chi" type="button">Số
                                                    tiền</button>
                                                <button class="dropdown-item btndropdownn text-13-black btn-fund_chi"
                                                    id="btn-fund_chi" data-button="fund_chi"
                                                    type="button">Quỹ</button>
                                                <button class="dropdown-item btndropdownn text-13-black btn-note_chi"
                                                    id="btn-note_chi" data-button="note_chi" type="button">Ghi
                                                    chú</button>
                                            </div>
                                        </div>
                                        <x-filter-date-time name="date_chi" button="date_chi" title="Ngày" />
                                        <x-filter-text name="chungtu_chi" title="Chứng từ" />
                                        <x-filter-text name="name_chi" title="Tên" />
                                        <x-filter-checkbox :dataa='$content_chi' name="content_chi" title="Nội dung chi"
                                            namedisplay="name" />

...
<div class="content-wrapper m-0 min-height--none">
        ...
        <section class="content-header--options p-0 border-custom">
            <div class="w-100">
                <ul class="header-options--nav-2 nav nav-tabs margin-left32 border-bottom-0 w-100 custom-nav"
                    ...
                    <li>
                        <a class="text-secondary px-1 text-15" data-toggle="tab" href="#changeFund">Chuyển tiền nội bộ
                        </a>
                    </li>
                    <li>
                        <a class="text-secondary px-1 text-15" data-toggle="tab" href="#contentImportExport">Tổng hợp
                            nội dung thu-chi
                        </a>
                    </li>
                    <li>
    ...
    <div class="tab-content">
                                                    ...
                                                    <th scope="col" class="bg-white pl-0">
                                                        <span class="d-flex">
                                                            <a href="#" class="sort-link btn-submit"
                                                                ...
                                                                data-sort-type="DESC">
                                                                <button class="btn-sort" type="submit">
                                                                    <span class="text-13">Người lập</span>
                                                                </button>
                                                            </a>
                                                            <div class="icon" id="icon-export-sumAmountOwed">
                                                            </div>
                                                    ...
                                                    <th scope="col" class="bg-white pl-0">
                                                        <span class="d-flex">
                                                            <a href="#" class="sort-link btn-submit"
                                                                ...
                                                                data-sort-type="DESC">
                                                                <button class="btn-sort" type="submit">
                                                                    <span class="text-13">Từ quỹ</span>
                                                                </button>
                                                            </a>
                                                            <div class="icon" id="icon-export-sumAmountOwed">
                                                            </div>
                                                    ...
                                                    <th scope="col" class="bg-white pl-0">
                                                        <span class="d-flex">
                                                            <a href="#" class="sort-link btn-submit"
                                                                ...
                                                                data-sort-type="DESC">
                                                                <button class="btn-sort" type="submit">
                                                                    <span class="text-13">Đến quỹ</span>
                                                                </button>
                                                            </a>
                                                            <div class="icon" id="icon-export-sumAmountOwed">
                                                            </div>
        ...
        <div id="debtFunds" class="tab-pane fade">
            <div class="content margin-top-fixed10">
                <!-- Main content -->
                <section class="content margin-250">
                    <div class="container-fluided">
                                                    ...
                                                    <th scope="col" class="bg-white pl-0">
                                                        <span class="d-flex justify-content">
                                                            <a href="#" class="sort-link btn-submit"
                                                                ...
                                                                data-sort-type="DESC">
                                                                <button class="btn-sort" type="submit">
                                                                    <span class="text-13">Trả hàng NCC</span>
                                                                </button>
                                                            </a>
                                                            <div class="icon" id="icon-export-sumAmountOwed">
                                                            </div>
        ...
        <div id="contentImportExport" class="tab-pane fade">
            <div class="content margin-top-fixed10">
                <!-- Main content -->
                <section class="content margin-250">
                    <div class="container-fluided">
        ...
        {{-- Trả hàng NCC --}}
        <div id="returnImport" class="tab-pane fade">
            <div class="content margin-top-fixed10">
                <!-- Main content -->
                <section class="content margin-250">
                    <div class="container-fluided">

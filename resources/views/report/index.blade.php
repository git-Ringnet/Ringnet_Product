...
<div class="content-wrapper m-0 min-height--none">
    <div class="content-header-fixed p-0 margin-250">
        ...
        <section class="content-header--options p-0 border-custom">
            <ul class="header-options--nav2 nav justify-content-evenly nav-tabs margin-left32">
                <li>
                    <a class="text-secondary pl-3 active" data-toggle="tab" href="#buy">Mua hàng</a>
                </li>
                 <li style="margin-left: 11px;">
                    <a class="text-secondary pr-3" data-toggle="tab" href="#sell">Bán hàng</a>
                 </li>
            </ul>
        </section>
    </div>
                    ...
                    <div class="row p-0 m-0">
                        <div class="col-12 p-0 m-0">
                                                ...
                                                <div class="col-md-5 d-flex align-items-center">
                                                    ...
                                                    <div class="dropdown mx-1">
                                                        <button class="filter-btn ml-2 align-items-center d-flex border mb-0" data-toggle="dropdown">
                                                            ...
                                                            <span class="text-btnIner mx-1">Bộc lọc</span>
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M4.82078 6.15415C5.02632 5.94862 5.35956 5.94862 5.5651 6.15415L7.99996 8.58901L10.4348 6.15415C10.6404 5.94862 10.9736 5.94862 11.1791 6.15415C11.3847 6.35969 11.3847 6.69294 11.1791 6.89848L8.37212 9.70549C8.16658 9.91103 7.83334 9.91103 7.6278 9.70549L4.82078 6.89848C4.61524 6.69294 4.61524 6.35969 4.82078 6.15415Z" fill="#26273B" fill-opacity="0.8"/>
                                                            </svg>
                                                        </button>
                            ...
                            <div class="border-custom">
                                <div class="margin-left32 py-3">
                                    <span class="text-13">Tổng số doanh thu mua hàng: <span> <= </span></span>
                                    <span class="text-13">2.000.000.000</span>
                                </div>
                            </div>
                            <div class="">
                                        ...
                                        <table id="example2" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" style="width:150px;" class="border-left-0 border-right-0 border-bottom-1"></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                ...
                <div id="sell" class="tab-pane fade">
                    <div class="row p-0 m-0">
                        <div class="col-12 p-0 m-0">
                            ...
                            <div class="border-custom">
                                <div class="margin-left32 py-3">
                                    <span class="text-13">Tổng số doanh thu bán hàng: <span> <= </span></span>
                                    <span class="text-13">2.000.000.000</span>
                                </div>
                            </div>
                            <div class="">

...
<div class="content-wrapper m-0 p-0 min-height--none">
    ...
    <div class="content-header-fixed p-0 margin-250">
        ...
        <section class="border-custom d-flex" style="height: 50px;">
            <div class="toggle">
                <ul class="header-options--nav2 nav nav-tabs margin-left32">
                    <li>
    ...
    <div class="tab-content margin-top-68">
        {{-- Mua hàng --}}
            ...
            <div class="content">
                ...
                <section class="content margin-250">
                    ...
                    <div class="border-custom">
                        <div class="margin-left32 text-13 py-3">
                            <span>Tổng số doanh thu mua hàng: <span> <= </span></span>
        ...
        <div id="export" class="tab-pane fade">
            <div class="content">
                ...
                <section class="content margin-250">
                    ...
                    <div class="border-custom">
                        <div class="margin-left32 text-13 py-3">
                            <span>Tổng số doanh thu bán hàng: <span> <= </span></span>

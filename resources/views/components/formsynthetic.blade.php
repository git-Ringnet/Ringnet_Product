                ...
                <div class="m-3 ">
                    ...
                    <div class="d-flex justify-content-between mt-2 align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            <input id="voucher"
                                @if ($import != '') value="{{ number_format($import->discount) }}" 
                            ...
                            <span
                                class="percent_discount @if ($import != '' && $import->discount_type == 2) d-block @else d-none @endif">%</span>
                            <select @if ($import != '' && $import->status != 1) disabled @endif id="discount_type"
                                name="discount_type"
                                class="border-0 height-32 text-13-blue text-center discount_type bg-input-guest">
                                <option value="1" @if ($import != '' && $import->discount_type == 1) selected @endif>Nhập tiền
                                </option>

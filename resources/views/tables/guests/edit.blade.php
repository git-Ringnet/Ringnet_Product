                            ...
                            <div class="info-chung">
                                <div class="content-info">
                                    <div class="d-flex align-items-center height-60-mobile">
                                        ...
                                        <input type="text" required placeholder="Nhập thông tin" name="guest_name"
                                    ...
                                    <div class="d-flex align-items-center height-60-mobile">
                                        ...
                                        <input type="text" placeholder="Nhập thông tin" name="guest_name_display"
...
<script type="text/javascript">
    ...
    $("#add-field-btn").click(function() {
        ...
        const hoTen = $(
            "<td class='border border-top-0 border-bottom-0 border-left-0 padding-left35 px-0'><input type='hidden' name='represent_id[]'><input type='text' autocomplete='off' class='border-0 py-1 w-100 text-13-black represent_name' required name='represent_name[]'></td>"
        );
        const email = $(
            "<td class='border border-top-0 border-bottom-0'><input type='email' autocomplete='off' class='border-0 py-1 w-100 text-13-black represent_email' name='represent_email[]'></td>"
        );
        const soDT = $(
            "<td class='border border-top-0 border-bottom-0'><input type='number' autocomplete='off' class='border-0 py-1 w-100 text-13-black represent_phone' name='represent_phone[]'></td>"
        );
        const diaChi = $(
            "<td class='border border-top-0 border-bottom-0'><input type='text' autocomplete='off' class='border-0 py-1 w-100 text-13-black represent_address' name='represent_address[]'></td>"
        );
        const option = $(
            "<td class='border border-top-0 border-bottom-0 border-right-0 text-left' data-name1='KH' data-des='Xóa người đại diện ở trang sửa'>" +

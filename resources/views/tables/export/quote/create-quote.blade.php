...
<form id="form-submit" action="{{ route('detailExport.store', ['workspace' => $workspacename]) }}" method="POST">
    ...
    <div class="content-wrapper--2Column m-0 min-height--none">
        ...
        <div class="content-wrapper2 px-0 py-0 margin-top-75">
            <x-view-mini :listDetail="$listDetail" :workspacename="$workspacename" :page="'PBH'" :status="'1'" :guest="$guest" :listUser="$listUser" />
...
<script type="text/javascript">
    ...
    flatpickr("#date_payment", {
        ...
        onChange: function(selectedDates, dateStr, instance) {
            // Cập nhật giá trị của trường ẩn khi người dùng chọn ngày
            document.getElementById("hiddenDatePayment").value = instance.formatDate(selectedDates[0],
                "Y-m-d");
        }
    });
    ...
    $(document).ready(function() {
        ...
        toggleListGuest($("#myInput1"), $("#ListGuest"), $("#showListGuest"));

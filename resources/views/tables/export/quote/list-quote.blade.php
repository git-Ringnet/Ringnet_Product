                                        ...
                                        @foreach ($quoteExport as $value_export)
                                            <tr class="position-relative" onclick="handleRowClick('checkbox', event);">
                                                <td class="bg-white text-13-black">
                                                    ...
                                                    <input type="checkbox" class="cb-element checkall-btn" name="ids[]" id="checkbox"
                                                ...
                                                <td class="bg-white">
                                                    <div class="">
                                                        <a href="{{ route('seeInfo', ['workspace' => $workspacename, 'id' => $value_export->maBG]) }}"
                                                            class="duongDan text-13-black">{{ $value_export->quotation_number }}</a>
                                                    </div>
                                                </td>
                                                <td class="bg-white text-13-black max-width120">{{ $value_export->reference_number }}
                                                </td>
                                                <td class="bg-white text-13-black max-width180">{{ $value_export->guest_name_display }}
                                                </td>
                                                <td class="bg-white text-13-black"><a href="#"></a></td>
                                                <td class="bg-white text-13-black">

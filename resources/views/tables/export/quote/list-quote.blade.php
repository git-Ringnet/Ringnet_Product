                                ...
                                <tbody>
                                    @foreach ($quoteExport as $value_export)
                                        <tr onclick="handleRowClick('checkbox', event);">
                                            ...
                                            <td class="border-top-0 bg-white">{{ $value_export->quotation_number }}
                                            </td>
                                            <td class="border-top-0 bg-white">{{ $value_export->reference_number }}
                                            </td>
                                            <td class="border-top-0 bg-white">{{ $value_export->guest_name_display }}
                                            </td>
                                            <td class="border-top-0 bg-white"><a href="#"></a></td>
                                            <td class="border-top-0 bg-white text-left">

        ...
        <div class="content" style="margin-top: 3.8rem;" id="main">
            <section class="container-fluided margin-250">
                <div class="container-fluided">
                    ...
                    <div class="content">
                        <div class="ontent-info position-relative table-responsive text-nowrap">
                                            ...
                                            <ul class="p-0 m-0">
                                                <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left position-relative" style="height:44px;">
                                                    ...
                                                    <input class="text-13-black w-50 border-0 bg-input-guest" 
                                                        ...
                                                        style="flex:2;" value="{{ $detailExport->represent_name }}" autocomplete="off">
                                                    ...
                                                    <div id="myUL7"
                                                        ...
                                                        <a type="button"
                                                            ...
                                                            data-toggle="modal" data-target="#representModal" style="bottom: 0;border-radius:4px;background-color:#F2F2F2;">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                    <path d="M8.75 3C8.75 2.58579 8.41421 2.25 8 2.25C7.58579 2.25 7.25 2.58579 7.25 3V7.25H3C2.58579 7.25 2.25 7.58579 2.25 8C2.25 8.41421 2.58579 8.75 3 8.75H7.25V13C7.25 13.4142 7.58579 13.75 8 13.75C8.41421 13.75 8.75 13.4142 8.75 13V8.75H13C13.4142 8.75 13.75 8.41421 13.75 8C13.75 7.58579 13.4142 7.25 13 7.25H8.75V3Z" fill="#282A30"/>
                                                                </svg>
                                                ...
                                                <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                                    ...
                                                    <input class="text-13-black w-50 border-0 bg-input-guest "id="datePicker"
                                                        name="date_quote" style="flex:2;"  value="{{ date_format(new DateTime($detailExport->ngayBG), 'd/m/Y') }}" />
                                                ...
                                                <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left position-relative" style="height:44px;">
                                                    ...
                                                    <div id="myUL2"
                                                            ...
                                                            <a type="button"
                                                                ...
                                                                <span class="text-13-black pl-3 pt-1" style="font-weight: 600 !important;">Thêm hiệu lực</span>
                                                            </a>
                                                        </div>
                                                </li>
                                                <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left position-relative" style="height:44px;">
                                                ...
                                                <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left position-relative" style="height:44px;">
                                                    ...
                                                    <div id="listProject"
                                                        ...
                                                        <a type="button"
                                                            class="d-flex align-items-center p-2 position-sticky addGuestNew mt-2"
                                                            data-toggle="modal" data-target="" style="bottom: 0;border-radius:4px;background-color:#F2F2F2;">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                    <path d="M8.75 3C8.75 2.58579 8.41421 2.25 8 2.25C7.58579 2.25 7.25 2.58579 7.25 3V7.25H3C2.58579 7.25 2.25 7.58579 2.25 8C2.25 8.41421 2.58579 8.75 3 8.75H7.25V13C7.25 13.4142 7.58579 13.75 8 13.75C8.41421 13.75 8.75 13.4142 8.75 13V8.75H13C13.4142 8.75 13.75 8.41421 13.75 8C13.75 7.58579 13.4142 7.25 13 7.25H8.75V3Z" fill="#282A30"/>
                                                                </svg>
                                                ...
                                                <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left position-relative" style="height:44px;">
                                                    ...
                                                    <div id="myUL6"
                                                        ...
                                                        <a type="button"
                                                            class="d-flex align-items-center p-2 position-sticky addGuestNew mt-2"
                                                            data-toggle="modal" data-target="#formModallocation" style="bottom: 0;border-radius:4px;background-color:#F2F2F2;">
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                                                    <path d="M8.75 3C8.75 2.58579 8.41421 2.25 8 2.25C7.58579 2.25 7.25 2.58579 7.25 3V7.25H3C2.58579 7.25 2.25 7.58579 2.25 8C2.25 8.41421 2.58579 8.75 3 8.75H7.25V13C7.25 13.4142 7.58579 13.75 8 13.75C8.41421 13.75 8.75 13.4142 8.75 13V8.75H13C13.4142 8.75 13.75 8.41421 13.75 8C13.75 7.58579 13.4142 7.25 13 7.25H8.75V3Z" fill="#282A30"/>
                                                                </svg>
                        ...
                        <div class="modal-body">
                            <div class="content-info">
                                ...
                                <div class="ml-2">
                                    ...
                                    <input name="" type="text" placeholder="Nhập thông tin"
                                        class="border w-100 py-2 border-top-0 border-left-0 border-right-0 bg-input-guest text-13-black"
                                         id="represent_guest_address"
                                        autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer border-top-0">
                            <button type="button" class="btn-destroy text-btnIner-primary"
                                data-dismiss="modal">Trở về</button>
                            <button type="button" class="custom-btn text-btnIner-primary"
            ...
            <div class="modal fade" id="representModal" tabindex="-1" role="dialog" aria-labelledby="productModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="content-info">
                                        ...
                                        <div class="ml-2">
                                            ...
                                            <input name="represent_email"
                                                    id="represent_email" type="text" placeholder="Nhập thông tin"
                                                class=" border w-100 py-2 border-top-0 border-left-0 border-right-0 bg-input-guest text-13-black" 
                                                autocomplete="off" >
                                        </div>
                                        <div class="ml-2">
                                            ...
                                            <input name="represent_address" id="represent_address" type="text" placeholder="Nhập thông tin"
                                                class="key border w-100 py-2 border-top-0 border-left-0 border-right-0 bg-input-guest text-13-black" 
                                                autocomplete="off" >
                                        </div>
                            </div>
                            <div class="modal-footer border-top-0">
                                <button type="button" class="btn-destroy text-btnIner-primary" data-dismiss="modal">
                                    <span>Trở về</span>
                                </button>
                                <button type="button" class="custom-btn text-btnIner-primary"
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(index, representative) {
                                var listItem = $('<li class="border" data-id = ' + representative.id + '>')
                                    .append(
                                        $('<a>').attr({
                                            href: '#',
                                            ...
                                            ).text(representative.represent_name)
                                        )
                                    ).append(
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#representativeList').empty();
                $.each(data, function(index, representative) {
                    var listItem = $('<li class="p-2 align-items-center" data-id = ' + representative.id +' style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">')
                        .append($('<a>').attr({
                                href: '#',
                                title: representative.represent_name,
                                class: 'text-dark d-flex justify-content-between search-represent p-2 w-100',

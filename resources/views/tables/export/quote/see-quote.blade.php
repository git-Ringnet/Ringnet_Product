                    ...
                    <div class="row m-0">
                        <div class="dropdown">
                            <a href="{{ route('detailExport.index', $workspacename) }}">
                                <button type="button" class="btn-save-print rounded mx-1 d-flex align-items-center h-100">
                                ...
                                <ul class="m-0 p-0 scroll-data">
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" onclick="getAction(this)" id="btnThanhToan">
                                            <button name="action" value="action_4" type="submit" style="background-color: transparent;"
                                                class="align-items-left h-100 border-0 w-100 rounded hover-button">
                                                <span style="font-weight: 600;color: #000; font-size:13px">Tạo đơn thanh toán</span>
                                            </button>
                                        </a>
                                    </li>
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" onclick="getAction(this)" id="btnHoaDon">
                                            <button name="action" value="action_3" type="submit" style="background-color: transparent;"
                                                class="align-items-left h-100 border-0 w-100 rounded hover-button">
                                                <span style="font-weight: 600;color: #000; font-size:13px">Tạo hóa đơn</span>
                                            </button>
                                        </a>
                                    </li>
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" onclick="getAction(this)" id="btnNhan">
                                            <button name="action" value="action_2" type="submit" style="background-color: transparent;"
                                                class="align-items-left h-100 border-0 w-100 rounded hover-button">
                                                <span style="font-weight: 600;color: #000; font-size:13px">Tạo đơn giao hàng</span>
                                            </button>
                                        </a>
                                    </li>
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" onclick="getAction(this)" id="btnMuaHang">
                                            <button name="action" value="action_6" type="submit" style="background-color: transparent;"
                                                class="align-items-left h-100 border-0 w-100 rounded">
                                                <span style="font-weight: 600;color: #000; font-size:13px">Tạo đơn mua hàng</span>
                                            </button>
                                        </a>
                                    </li>
                                </ul>
                                            ...
                                            @foreach ($quoteExport as $item_quote)
                                                <tr style="height:80px;">
                                                    ...
                                                    <td class="border bg-white align-top p-2">
                                                        <select name="product_tax[]"
                                                            class="border-0 text-center" disabled>
                                                            <option value="0" <?php if ($item_quote->product_tax == 0) {
                                                                echo 'selected';
                                                            } ?>>0%</option>
                                                            <option value="8" <?php if ($item_quote->product_tax == 8) {

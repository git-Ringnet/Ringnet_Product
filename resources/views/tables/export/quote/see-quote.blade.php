...
<div class="content-wrapper">
    <form
        action="{{ route('detailExport.update', ['workspace' => $workspacename, 'detailExport' => $detailExport->maBG]) }}"
        ...
        <section class="content-header p-0">
            <div class="container-fluided">
                ...
                <div class="row m-0 mb-1">
                    ...
                    <a href="#" onclick="getAction(this)" class="ml-2" id="btnMuaHang">
                                ...
                                <div class="info-chung">
                                    ...
                                    <div class="content-info">
                                        <div class="d-flex ml-2 align-items-center">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <input type="hidden" class="idGuest" autocomplete="off"
                                                    name="guest_id" value="{{ $detailExport->maKH }}">
                                            </div>
                                        </div>
                                        <div class="d-flex ml-2 align-items-center">
                                        ...
                                        <div class="d-flex ml-2 align-items-center">
                                            ...
                                            <div class="w-100">
                                                <input type="text" readonly
                                                    value="{{ $detailExport->reference_number }}"

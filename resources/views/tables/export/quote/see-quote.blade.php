                    ...
                    <div class="row m-0">
                        ...
                        <div class="dropdown">
                            <button type="button" data-toggle="dropdown"
                                class="btn-destroy btn-light mx-2 d-flex align-items-center h-100 dropdown-toggle"
                            ...
                            <div class="dropdown-menu" style="z-index: 9999;">
                                <a class="dropdown-item text-btnIner" href="{{ route('excel', $detailExport->maBG) }}">Xuất
                                    Excel</a>
                                <a class="dropdown-item text-btnIner border-top"
                                    href="{{ route('pdf', $detailExport->maBG) }}">Xuất PDF</a>
                            </div>
                        </div>
                            ...
                            <div class="bg-white position-absolute rounded shadow p-2 z-index-block"
                                ...
                                <ul class="m-0 p-0 scroll-data">
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" style="flex:2;" onclick="getAction(this)" id="btnNhan"
                                            name="search-info" class="search-info">
                                            <button class="align-items-left h-100 border-0 w-100 rounded" 
                                            style="background-color: transparent;" name="action" value="action_2" type="submit"> 
                                                <span style="font-weight: 600;color: #000; font-size:13px">Thêm giao hàng</span>
                                            </button>
                                        </a>
                                    </li>
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" style="flex:2;" onclick="getAction(this)" id="btnHoaDon"
                                            name="search-info" class="search-info">
                                            <button class="align-items-left h-100 border-0 w-100 rounded " 
                                            style="background-color: transparent;" name="action" value="action_3" type="submit"> 
                                                <span style="font-weight: 600;color: #000; font-size:13px">Thêm bán hàng</span>
                                            </button>
                                        </a>
                                    </li>
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" style="flex:2;" onclick="getAction(this)" id="btnThanhToan"
                                            name="search-info" class="search-info">
                                            <button class="align-items-left h-100 border-0 w-100 rounded" 
                                                    style="background-color: transparent;" name="action" value="action_4" type="submit">
                                                <span style="font-weight: 600;color: #000; font-size:13px">Thêm thanh toán</span>
                                            </button>
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="container-fluided">
                    <div class="tab-content">
                        <div id="info" class="content tab-pane in active">
                            <div class="content">
                                <p class="font-weight-bold text-uppercase info-chung--heading text-center  border-custom">THÔNG TIN SẢN PHẨM</p>
                                            ...
                                            <tbody>
                                                @foreach ($quoteExport as $item_quote)
                                                    <tr class="bg-white" style="height:80px;">
                                                        ...
                                                        <td class="border bg-white align-top text-13-black position-relative">
                            ...
                            <div class="content">
                                <p class="font-weight-bold text-uppercase info-chung--heading text-left  border-custom">Hệ thống ACCESS POINT</p>
                                <section class="card scroll-custom mb-0">
                                    <div class="table-responsive text-nowrap order_content">
                                        <table class="table table-hover bg-white rounded m-0">
                                            <thead>
                                        ...
                                        <tbody>
                                            @foreach ($quoteExport as $item_quote)
                                                <tr style="height:80px;">
                                                    <td class="border bg-white align-top text-13-black p-1" style="padding-left: 2rem !important;">
                                                        <input type="text" autocomplete="off" readonly
                                                            value="{{ $item_quote->product_code }}"
                                                            class="border-0 py-1 w-75 product_code"
                                                            name="product_code[]">
                                                    ...
                                                    <td class="border bg-white align-top text-13-black p-1"  style="width:11%">
                                                        <div>
                                                            <input type='text' 
                                                            value="{{ is_int($item_quote->product_qty) ? $item_quote->product_qty : rtrim(rtrim(number_format($item_quote->product_qty, 4, '.', ''), '0'), '.') }}"
                                                    ...
                                                    <td class="border bg-white align-top text-13-black p-1" style="width:12%">
                                                        <div>
                                                            <input type="text"
                                                                value="{{ number_format($item_quote->price_export) }}"
                                                    ...
                                                    <td class="text-center border bg-white align-top text-13-black p-1">
                                                        <input type="text" class="border-0 py-1 w-100" readonly
                                                            name="product_note[]"

    ...
    <div class="d-flex justify-content-between align-items-center pl-4 ml-1">
        <div class="container-fluided">
            <div class="mb">
                ...
                <span class="font-weight-bold text-secondary">Hóa đơn bán hàng</span>
            </div>
        </div>
                                            ...
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="id"
                                                    ...
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Ngày hóa đơn</span>
                                                    </button>
                                                </a>
                                        ...
                                        <th scope="col" class="border-top-0 my-0 py-2">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="export_code"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Số hóa đơn</span>
                                                    </button>
                                                </a>
                                        ...
                                        <th scope="col" class="border-top-0 my-0 py-2">
                                            <span class="d-flex justify-content-center">
                                                <a href="#" class="sort-link" data-sort-by="total"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Tổng tiền</span>
                                                    </button>
                                                </a>
                                                <div class="icon" id="icon-total"></div>
                                            </span>

...
<div class="content-wrapper m-0 min-height--none">
    ...
    <div class="main-content p-2 margin-top--53">
                                            ...
                                            <th scope="col" class="height-52 border-0">
                                                <span class="d-flex">
                                                    <a href="#" class="sort-link" data-sort-by="id"
                                                        data-sort-type="#">
                                                        <button class="btn-sort text-13" type="submit">Ngày hóa đơn</button>
                                                    </a>
                                            ...
                                            <th scope="col" class="height-52 border-0">
                                                <span class="d-flex">
                                                    <a href="#" class="sort-link" data-sort-by="created_at"
                                                        data-sort-type="">
                                                        <button class="btn-sort text-13" type="submit">Số hóa đơn#</button>
                                                    </a>
                                    ...
                                    <tbody>
                                        @foreach ($billSale as $item_bill)
                                            <tr class="position-relative" onclick="handleRowClick('checkbox', event);">
                                                ...
                                                <td class="text-13-black td-theSecond">
                                                    {{ $item_bill->number_bill }}
                                                </td>
                                                <td class="text-13-black max-width120">
                                                    <a class="text-13-black" href="{{ route('billSale.edit', ['workspace' => $workspacename, 'billSale' => $item_bill->idHD]) }}">
                                                        {{ $item_bill->quotation_number }}
                                                    </a>
                                                </td>
                                                <td class="text-13-black max-width120">
                                                    {{ $item_bill->guest_name_display }}
                                                </td>
                                                <td class="text-13-black">
                                                ...
                                                <td class="icon-td position-absolute m-0 p-0 border-0 bg-hover-icon"
                                                        ...
                                                        <a href="#">
                                                            <div class="m-0 mx-2 rounded">
                                                                <form
                                                                    ...
                                                                    action="{{ route('billSale.destroy', ['workspace' => $workspacename, 'billSale' => $item_bill->idHD]) }}"

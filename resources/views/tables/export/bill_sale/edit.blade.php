                ...
                <div class="d-flex content__heading--right mr-3">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" style="z-index: 9999;">
                            <a class="dropdown-item" href="{{ route('pdfdelivery', $billSale->idHD) }}">Xuất PDF</a>
                        </div>
                    </div>
                                        ...
                                        @foreach ($product as $item)
                                            <tr class="bg-white" style="height:80px;">
                                                <td class='border-right p-2 text-13 align-top'>
                                                            <input type='text'  readonly value="{{ $item->product_code }}" 
                                                            autocomplete='off' class='border-0 pl-0 pr-2 py-1 w-50 product_code' 
                                                            name='product_code[]'> 
                                                </td>
                                                ...
                                                <td class='border-right p-2 text-13 align-top'>
                                                            ...
                                                            <div class='mt-3 text-13-blue inventory' tyle="top: 68%; display: none;">Tồn kho: <span class='pl-1 soTonKho'>35</span></div>
                                                </td>
                                                <td class='border-right p-2 text-13 align-top'>
                                                            <div>
                                ...
                                <div class="position-relative col-lg-5 col-md-7 col-sm-12 margin-left180">
                                    <div class="m-3">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span id="total-amount-sum" class="text-13-black">0đ</span>
                                        </div>
                                        <div class="d-flex justify-content-between mt-2">
                                            <span class="text-13-black">Thuế VAT: </span>
                                            <span id="product-tax" class="text-13-black">0đ</span>
                                        </div>
                                        <div class="d-flex justify-content-between mt-2">
                        ...
                        <div class="content-info--common" id="show-info-guest">
                                    <ul class="p-0 m-0 ">
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            ...
                                            <input class="text-13-black w-50 border-0 numberQute bg-input-guest" id="myInput"
                                        ...
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            ...
                                            <input class="text-13-black w-50 border-0 nameGuest bg-input-guest" 
                                                    ...
                                                    style="flex:2;">
                                            <input type="hidden" class="idGuest" autocomplete="off" name="guest_id"  value="{{ $billSale->guest_id }}">
                                        </li>
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                        ...
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            ...
                                            <input class="text-13-black w-50 border-0" name="number_bill"
                                                    style="flex:2;" value="{{ $billSale->number_bill }}"/>
                                        </li>
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Ngày hóa đơn</span>
                                            <input class="text-13-black w-50 border-0" style="flex:2;" name="date_bill"
                ...
                if (Array.isArray(data) && data.length > 0) {
                    ...
                    $('#productModal').find('.modal-body').html('<b>Tên sản phẩm: </b> ' +
                        ...
                        .product_unit + '<br>' + '<b>Tồn kho: </b>' + (productData
                            ...
                            .product_tax == 99 || productData.product_tax == null ? "NOVAT" : productData.product_tax + '%'
                        ));
                }
            }
        });

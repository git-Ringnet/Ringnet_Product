                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="z-index: 9999;">
                                <a class="dropdown-item text-nav border-top"
                                    href="{{ route('pdfBillSale', $billSale->idHD) }}">Xuất PDF</a>
                            </div>
                        </div>
                                            ...
                                            @foreach ($product as $item)
                                                <tr class="bg-white addProduct" style="height:80px;">
                                                    <td class='border-right border-top-0 p-2 text-13 align-top border-bottom'
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="text" autocomplete="off" readonly=""
                                                                ...
                                                                class='border-0 pl-0 pr-2 py-1 w-75 product_code text-left height-32'
                                                                name="product_code[]">
                                                        </div>
                                                    </td>
                                                    <td
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <input type="text" value="{{ $item->product_name }}"
                                                                class='border-0 pl-0 pr-2 py-1 w-100 product_name text-left height-32'
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="#">
                                                            <div class="mt-3 text-13-blue transaction recentModal activity text-right"
                                                                data-name1="HDBH"
                                            ...
                                            <div class="d-flex justify-content-between mt-2 align-items-center">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <input id="voucher" type="text" name="voucher"
                                                        ...
                                                        value="{{ number_format($billSale->discount) }}" readonly>
                                                    @if ($billSale->discount_type == 2)
                                                    ...
                                                    <select name="discount_type" disabled
                                                        ...
                                                        <option value="1" <?php if ($billSale->discount_type == 1) {
                                                            echo 'selected';
                                                        } ?>>Nhập tiền</option>
                                                        <option value="2" <?php if ($billSale->discount_type == 2) {
                                                            echo 'selected';
                                                        } ?>>Nhập %</option>
                                                    </select>
                                                    <input type="hidden" class="discount_type"
                                                        value="{{ $billSale->discount_type }}">
                                                </div>
                                            </div>
            ...
            <div class="content-info--common" id="show-info-guest">
                <ul class="p-0 m-0 ">
                    ...
                    <li class="d-flex justify-content-between py-2 px-3 border-bottom align-items-center text-left"
                        ...
                        <input type="text" class="text-13-black w-50 border-0 bg-input-guest" id="dayPicker"
                            placeholder="Nhập thông tin" style="flex:2;" readonly
                            value="{{ date_format(new DateTime($billSale->ngayHD), 'd/m/Y') }}" />
                        <input type="hidden" id="hiddenDayInput" name="date_bill"
                            value="{{ date_format(new DateTime($billSale->ngayHD), 'Y-m-d') }}">
                    </li>
                </ul>
            </div>
        </div>

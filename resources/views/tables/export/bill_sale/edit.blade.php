                            ...
                            <div id="show_info_Guest">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="">
                                        ...
                                        <div
                                            class="border-top-0 d-flex align-items-center justify-content-between border border-left-0 py-1 px-1">
                                            <input type="text" readonly
                                                value="{{ $billSale->guest_name_display }}"
                                        ...
                                        <div
                                            class="border-top-0 d-flex align-items-center justify-content-between border border-left-0 py-1 px-1">
                                            <input type="text" readonly value="{{ $billSale->represent_name }}"

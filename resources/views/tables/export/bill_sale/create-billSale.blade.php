                                ...
                                var newRow = `
                                    <tr id="dynamic-row-${item.id}" class="bg-white sanPhamGiao" style="height:80px">
                                            ...
                                            <td class="border-right p-2 text-13 align-top">
                                                    <div>
                                                        <input type='text' value="${formatCurrency(item.soLuongHoaDon)}"
                                                            class='border-0 px-2 py-1 w-100 quantity-input text-right' autocomplete='off' required name='product_qty[]'>
                                            ...
                                            <td class="border-right p-2 text-13 align-top">
                                                ...
                                                <div class='mt-3 text-13-blue transaction' style=' display: none;'>Giao dịch gần đây</div>

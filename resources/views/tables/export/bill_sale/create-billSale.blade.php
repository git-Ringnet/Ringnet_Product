                                            ...
                                            @foreach ($quoteExport as $item)
                                                <tr id="dynamic-row" class="bg-white sanPhamGiao">
                                                    ...
                                                    <td class="border border-top-0 border-bottom-0">
                                                        <input type="text" readonly value="{{ $item->product_unit }}"
                                                            autocomplete="off"
                                                    ...
                                                    <td class="border border-top-0 border-bottom-0 px-4">
                                                        ...
                                                        <input type="hidden" class="product_tax"
                                                            value="{{ $item->product_tax }}" name="product_tax[]">
                                                    </td>
                                                    <td class="border border-top-0 border-bottom-0">
                                                        <input type="text"
                                                    ...
                                                    <td
                                                        ...
                                                        <input type="text" readonly value="{{ $item->product_ratio }}"

                            ...
                            <table id="example2" class="table table-hover">
                                <thead class="sticky-head">
                                    <tr>
                                        ...
                                        <th class="border-top-0 bg-white pl-0 my-0 py-2"><input type="checkbox" name="all" id="checkall"></th>
                                ...
                                <tbody>
                                    @foreach ($payExport as $item_pay)
                                        <tr class="position-relative" onclick="handleRowClick('checkbox', event);">
                                            ...
                                            <td class="pl-0 py-2"><input type="checkbox" class="cb-element" name="ids[]"
                                            ...
                                            <td class="position-absolute m-0 p-0 border-0 bg-hover-icon"
                                                ...
                                                <div class="d-flex w-100">
                                                    <a href="{{ route('payExport.edit', ['workspace' => $workspacename, 'payExport' => $item_pay->idThanhToan]) }}">

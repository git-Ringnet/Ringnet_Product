...
<div class="content-wrapper m-0">
    <form action="{{ route('payExport.store', ['workspace' => $workspacename]) }}" method="POST">
        ...
        <section class="content-header-fixed p-0 margin-250">
            <div class="content__header--inner margin-left32">
                <div class="content__heading--left">
                    ...
                    <span class="font-weight-bold last-span">Tạo thanh toán bán hàng</span>
                </div>
                <div class="d-flex content__heading--right">
                    ...
                    <button type="submit" class="btn-destroy btn-light d-flex align-items-center h-100"
        ...
        <!-- Main content -->
        <section class="content margin-top-fixed2 border-custom">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-xl-3 col-lg-12 col-sm-12 col-md-12 p-0 border">
                        <div class="info-chung" id="show_info_Guest" style="height:100vh;">
                            <p class="font-weight-bold text-uppercase info-chung--heading text-center">Thông tin chung
                            </p>
                                ...
                                <div class="d-flex justify-content-between py-2 px-3 border align-items-center text-left text-nowrap"
                                    ...
                                    <span class="mx-1 text-13" style="flex: 2;">
                                        <input type="text" placeholder="Chọn thông tin"
                                            ...
                                            required name="quotation_number">
                                ...
                                <ul class="p-0 m-0 ">
                                    ...
                                    <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                        ...
                                        <input class="text-13-black w-50 border-0 " style="flex:2;"
                                            id="represent_guest" />
                                        <input type="hidden" autocomplete="off" class="represent_guest_id"
                                    ...
                                    <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                        ...
                                        <input class="text-13-black w-50 border-0 " id="customDateInput" name="date_pay"
                                            style="flex:2;" value="{{ date('Y-m-d') }}" />
                                    </li>
                                    <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                        style="height:44px;">
                                        <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Tổng tiền</span>
                                        <input class="text-13-black w-50 border-0 tongTien" style="flex:2;" />
                                    </li>
                                    <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                        style="height:44px;">
                                        <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Đã thanh toán</span>
                                        <input class="text-13-black w-50 border-0 daThanhToan" style="flex:2;" />
                                    </li>
                                    <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                        style="height:44px;">
                                        <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Dư nợ</span>
                                        <input class="text-13-black w-50 border-0 duNo" style="flex:2;" />
                                    </li>
                                    <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                        style="height:44px;">
                                        <span class="text-13 text-nowrap mr-2" style="flex: 1.5;">Thanh toán
                                            trước</span>
                                        <input class="text-13-black w-50 border-0 payment" style="flex:2;"
                                            name="payment" />
                                    </li>
                                </ul>
                            </div>
...
$(document).ready(function() {
    $("#add-field-btn").click(function() {
        ...
        const soLuong = $(
            ...
            "</div>" +
            "<div class='mt-3 text-13-blue inventory' style='display:none;'>Tồn kho: <span class='pl-1 soTonKho'>35</span></div>" +
            "</td>"
        );
        const donGia = $(
            "<td class='border-right p-2 text-13 align-top'>" +
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, item) {
                            $("#detailexport_id").val(item
                                .detailexport_id);
                            var totalTax = parseFloat(item.total_tax) ||
                                0;
                            ...
                            var newRow = `
                                        <tr id="dynamic-row-${item.id}" class="bg-white sanPhamGiao" style="height:80px;">
                                            ...
                                            <td class='border-right p-2 text-13 align-top'>
                                                ...
                                                <div class='mt-3 text-13-blue inventory'>Tồn kho: <span class='pl-1 soTonKho'>${item.product_inventory}</span></div>
                                            </td>
                            ...
                            document.querySelector('.payment')
                                .addEventListener('input', function() {
                                    ...
                                    var paymentValue = paymentInput
                                        .value;
                                    var duNoNumber = parseFloat(
                                        duNoValue.replace(/,/g,
                                            ''));
                                    var paymentNumber = parseFloat(
                                        paymentValue.replace(
                                            /,/g, ''));
                                    if (paymentNumber < 0 ||
                                        paymentNumber > duNoNumber
                                    ) {
                                        paymentInput.value =
                                            duNoValue;
                                    }
                            ...
                            $('.deleteProduct').click(function() {
                                ...
                                var productTaxText = $(
                                    '#product-tax').text();
                                var productTaxValue =
                                    parseFloat(productTaxText
                                        .replace(/,/g, ''));
                                var taxAmount = parseFloat((
                                        '.product_tax1')
                                    .text());
                                var totalTax = productTaxValue -
                                    taxAmount;
                                $('#product-tax').text(
                                    totalTax);
                            });
                            ...
                            $('.info-product').click(function() {
                                var productName = $(this)
                                    .closest('tr').find(
                                        '.product_name').val();
                                var dvt = $(this).closest('tr')
                                    .find('.product_unit')
                                    .val();
                                var thue = $(this).closest('tr')
                                    .find('.product_tax')
                                    .val();
                                var tonKho = $(this).closest(
                                        'tr').find('.tonkho')
                                    .val();
                                $('#productModal').find(
                                    '.modal-body').html(

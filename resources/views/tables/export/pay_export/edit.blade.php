        ...
        <section class="content-header-fixed p-0 margin-250">
            <div class="content__header--inner margin-left32">
                <div class="content__heading--left">
                    ...
                    <span class="font-weight-bold last-span">{{ $payExport->idTT }}</span>
                    ...
                    @elseif($payExport->trangThai == 2)
                            <span style="color: #08AA36; font-size:13px;" class="btn-status"class="btn-status">Thanh toán đủ</span>
                    @elseif($payExport->trangThai == 3)
                            <span style="color: #0052CC; font-size:13px;" class="btn-status"class="btn-status"> 
                                Đến hạn trong {{ $payExport->formatDate($payExport->payment_date)->diffInDays($today) + 1 }} ngày
                            </span>
                    @elseif($payExport->trangThai == 4)
                            <span style="color:#EC212D; font-size:13px;"class="btn-status">
                                Quá hạn trong {{ $payExport->formatDate($payExport->payment_date)->diffInDays($today) }} ngày
                            </span>
                    @else
                                            ...
                                            @foreach ($product as $item_quote)
                                                <tr id="dynamic-row-${item.id}" class="bg-white sanPhamGiao" style="height:80px;">
                                                    <td class='border-right p-2 text-13 align-top' style="padding-left: 2rem !important;">
                                                        <input type='text'  readonly value="{{ $item_quote->product_code }}" 
                                                    ...
                                                    <td class='border-right p-2 text-13 align-top position-relative'>
                                                        <div class="d-flex align-items-center">
                                                            <input type='text' class='border-0 px-2 py-1 w-100 product_name' 
                                                                    value="{{ $item_quote->product_name }}" autocomplete='off' readonly 
                                                                    name='product_name[]'> 
                                                            <input type='hidden' 
                                                    ...
                                                    <td class='border-right p-2 text-13 align-top'>
                                                        <div>
                                                            <input type='text' value="{{ number_format($item_quote->price_export) }}" class='text-right border-0 px-2 py-1 w-100 product_price' autocomplete='off' name='product_price[]' required>
                                                        </div>
                                                    ...
                                                    <td class='border-right p-2 text-13 align-top'>
                                                        <input type='text' 
                                                            value="{{ number_format($item_quote->product_total) }}" readonly 
                        ...
                        <div class="col-12 col-xl-3 col-lg-12 col-sm-12 col-md-12 p-0 border">
                                ...
                                <div class="content-info--common" id="show-info-guest">
                                    <ul class="p-0 m-0 ">
                                        ...
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            ...
                                            <input class="text-13-black w-50 border-0" style="flex:2;" value="{{ $payExport->idTT }}" />
                                        </li>
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Hạn thanh toán</span>
                                            <input class="text-13-black w-50 border-0 " id="customDateInput" name="date_pay" style="flex:2;"  
                                        ...
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            ...
                                            <input class="text-13-black w-50 border-0 daThanhToan" 
                                        ...
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            ...
                                            <input class="text-13-black w-50 border-0 duNo" 
                                                value="{{ number_format($noConLaiValue) }}" 
                                                readonly style="flex:2;" />
                                        </li>
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            <span class="text-13 text-nowrap mr-2" style="flex: 1.5;">Thanh toán trước</span>
                                            <input class="text-13-black w-50 border-0 payment" 
                                ...
                                <!-- <ul class="content-filter p-2" id="myUL">
                                    ...
                                    <div style="margin-top: 27px !important;" class="content-filter--list">
                                        <li class="p-2">
                                            <a href="#" name="search-info" class="search-info">

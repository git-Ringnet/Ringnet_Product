                    ...
                    <div class="row m-0">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="z-index: 9999;">
                                <a class="dropdown-item text-btnIner" href="{{ route('pdfdelivery', $payExport->idTT) }}">
                                    Xuất PDF
                                </a>
                            </div>
                        </div>
                                                ...
                                                <tr id="dynamic-row-${item.id}" class="bg-white sanPhamGiao" style="height:80px;">
                                                    <td class='border-right p-2 text-13 align-top' style="padding-left: 2rem !important;">
                                                        <input type='text'  readonly value="{{ $item_quote->product_code }}" 
                                                            autocomplete='off' class='border-0 pl-0 pr-2 py-1 w-100 product_code' 
                                                            name='product_code[]'> 
                                                    </td>
                                                    ...
                                                    <td
                                                        class="border-right p-2 text-13 align-top note p-1 border-right-0">
                    ...
                    <section class="content">
                        <div class="container-fluided">
                            <table class="table table-hover bg-white rounded" id="inputcontent">
                                <thead>
                                    <tr>
                                        <th class="text-table text-secondary p-1 border-right">Mã thanh toán</th>
                                        <th class="text-table text-secondary p-1 border-right">Ngày thanh toán</th>
                                        <th class="text-table text-secondary p-1 border-right">Tổng tiền</th>
                                        <th class="text-table text-secondary p-1 border-right">Thanh toán</th>
                                        <th class="text-table text-secondary p-1">Dư nợ</th>
                                    </tr>
                                </thead>
                                <tbody>

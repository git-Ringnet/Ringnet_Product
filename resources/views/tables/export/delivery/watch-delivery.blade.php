                ...
                <div class="d-flex content__heading--right mr-3">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" style="z-index: 9999;">
                            <a class="dropdown-item" href="{{ route('pdfdelivery', $delivery->soGiaoHang) }}">Xuất PDF</a>
                        </div>
                    </div>
                    ...
                    <button name="action" value="action_2" type="submit" id="xoaBtn"
                        ...
                        class="btn--remove d-flex align-items-center h-100 mx-2" style="background-color:red;">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M2.96967 2.96967C3.26256 2.67678 3.73744 2.67678 4.03033 2.96967L8 6.939L11.9697 2.96967C12.2626 2.67678 12.7374 2.67678 13.0303 2.96967C13.3232 3.26256 13.3232 3.73744 13.0303 4.03033L9.061 8L13.0303 11.9697C13.2966 12.2359 13.3208 12.6526 13.1029 12.9462L13.0303 13.0303C12.7374 13.3232 12.2626 13.3232 11.9697 13.0303L8 9.061L4.03033 13.0303C3.73744 13.3232 3.26256 13.3232 2.96967 13.0303C2.67678 12.7374 2.67678 12.2626 2.96967 11.9697L6.939 8L2.96967 4.03033C2.7034 3.76406 2.6792 3.3474 2.89705 3.05379L2.96967 2.96967Z" fill="white"/>
                            </svg>
                        </span>
                                                ...
                                                <tr class="bg-white addProduct" style="height:80px;">
                                                    <td class='border-right p-2 text-13 align-top' style="padding-left: 2rem !important;">
                                                        <input type='text'  readonly 
                                                            ...
                                                            autocomplete='off' class='border-0 pl-0 pr-2 py-1 w-75 product_code' 
                                                            name='product_code[]'> 
                                                    </td>
                                                    <td class='border-right p-2 text-13 align-top position-relative'>
                                                        <div class="d-flex align-items-center">
                                                            <input type='text' class='border-0 px-2 py-1 w-100 product_name' 
                                                                value="{{ $item->product_name }}" autocomplete='off' readonly 
                                                                name='product_name[]'> 
                                                            <input type='hidden' 
                                                                class='product_id' autocomplete='off' 
                                                    ...
                                                    <td class='border-right p-2 text-13 align-top'>
                                                        <div>
                                                            <input type='text' data-row="row{{ $item->product_id }}"
                                                            value="{{ is_int($item->deliver_qty) ? $item->deliver_qty : rtrim(rtrim(number_format($item->deliver_qty, 4, '.', ''), '0'), '.') }}"
                                                                class='text-right border-0 px-2 py-1 w-100 quantity-input' 
                                                                autocomplete='off' name='product_qty[]'>
                                                            <input type='hidden' class='tonkho'>
                                                        </div>
                                                        <div class='mt-3 text-13-blue inventory' tyle="top: 68%;">Tồn kho:  
                                                            <span class='pl-1 soTonKho'>{{ is_int($item->product_inventory) ? $item->product_inventory : rtrim(rtrim(number_format($item->product_inventory, 4, '.', ''), '0'), '.') }}</span>
                                                        </div>
                                                    </td>
                                                    <td class='border-right p-2 text-13 align-top'>
                                                        <div>
                                                             <input type='text' value="{{ number_format($item->price_export) }}" class='text-right border-0 px-2 py-1 w-100 product_price' autocomplete='off' name='product_price[]' required>
                                                        </div>
                                                        <div class='mt-3 text-13-blue'>Giao dịch gần đây</div>
                                                    </td>
                                                    <td class='border-right p-2 text-13 align-top'>
                                                        <select name='product_tax[]' class='border-0 px-2 py-1 w-100 text-left product_tax' readonly>
                                                            <option value="0" <?php if ($item->product_tax == 0) { echo 'selected';} ?> >0%</option>
                                                            <option value="8" <?php if ($item->product_tax == 8) { echo 'selected';} ?>>8%</option>
                                                            <option value="10" <?php if ($item->product_tax == 10) { echo 'selected'; } ?>>10%</option>
                                                            <option value="99" <?php if ($item->product_tax == 99) { echo 'selected'; } ?>>NOVAT </option>
                                                        </select>
                                                    </td>
                                                    <td class='border-right p-2 text-13 align-top'>
                                                        <input type='text' 
                                ...
                                <div class="info-chung" id="show_info_Guest" style="height:100vh;">
                                        ...
                                        <div class="d-flex justify-content-between py-2 px-3 border align-items-center text-left text-nowrap" style="height:44px;" style="height:44px;">
                                            ...
                                            <span class="mx-1 text-13" style="flex: 2;">
                                                <input type="text" placeholder="Chọn thông tin" readonly 
                                                    ...
                                                    autocomplete="off" name="guest_name_display">
                                                <input type="hidden" class="idGuest" value="{{ $delivery->guest_id }}"
                                    ...
                                    <div class="content-info--common" id="show-info-guest">
                                        <ul class="p-0 m-0 ">
                                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                                ...
                                                <input class="text-13-black w-50 border-0 bg-input-guest represent_guest"
                                                        value="{{ $delivery->represent_name }}"
                                                        style="flex:2;" readonly>
                                            </li>
                                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                                <span class="text-13 text-nowrap mr-3"style="flex: 1.5;">Số báo giá</span>
                                                <input class="text-13-black w-50 border-0" readonly
                                                    value="{{ $delivery->quotation_number }}"
                                                    style="flex:2;" name="quotation_number"/>
                                            </li>
                                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                                <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Mã giao hàng</span>
                                                <input class="text-13-black w-50 border-0" style="flex:2;" 
                                                        placeholder="Nhập thông tin" value="{{ $delivery->soGiaoHang }}" readonly />
                                            </li>
                                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                            ...
                                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                                ...
                                                <input type="text" readonly class="text-13-black w-50 border-0"
                                    ...
                                    <!-- <ul class="content-filter p-2" id="myUL">
                                        ...
                                        <div style="margin-top: 27px !important;" class="content-filter--list">
                                                <li class="p-2">
                                                    <a href="#" id="" name="search-info" class="search-info">

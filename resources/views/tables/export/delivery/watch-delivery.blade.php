                                ...
                                <table class="table table-hover bg-white rounded">
                                    <thead>
                                        <tr style="height:44px;">
                                            ...
                                            <th class="border-right p-0 px-1 text-center text-13"style="width:10%;">Thành tiền</th>
                                            ...
                                            <tr class="bg-white addProduct" style="height:80px;">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            ...
                                                            <div class='mt-3 text-13-blue inventory text-right' tyle="top: 68%;">Tồn kho:  
                                                                <span class='pl-1 soTonKho'>{{ is_int($item_quote->product_inventory) ? $item_quote->product_inventory : rtrim(rtrim(number_format($item_quote->product_inventory, 4, '.', ''), '0'), '.') }}</span>
                                                            </div>
                                                ...
                                                <td class="border-right p-2 text-13 align-top">
                                                    <input type="text"
                                                        ...
                                                        class="text-right border-0 px-2 py-1 w-100 product_price" autocomplete="off"
                                                ...
                                                <td class="border-right p-2 note text-13 align-top">
                                                    <input type="text" class='border-0 py-1 w-100' placeholder='Nhập ghi chú' readonly

            ...
            <div class="content__header--inner margin-left32">
                ...
                <div class="d-flex content__heading--right">
                    ...
                    <button type="submit" name="action" value="2"
                        class="btn-destroy btn-light mx-2 d-flex align-items-center h-100" style="margin-right:10px"
                    ...
                    <button type="submit" name="action" value="1" class="custom-btn d-flex align-items-center h-100"
                        style="margin-right:10px" onclick="kiemTraFormGiaoHang(event);" id="luuNhap">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <button id="sideGuest" type="button" class="btn-option border-0 mx-1">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="16" width="16" height="16" rx="5" transform="rotate(90 16 0)" fill="#ECEEFA" />
                            <path
            ...
            <div class="container-fluided margin-250">
                <div class="row">
                    <div class="col-12 col-xl-9 col-lg-12 col-sm-12 col-md-12 p-0 pl-2">
                        ...
                        <section class="content" style="margin-left: 2.3999rem;">
                                ...
                                <div class="position-relative col-lg-5 col-md-7 col-sm-12 margin-left180">
                                    <div class="m-3 ">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <span id="total-amount-sum" class="text-13-black text-right">
                                                @isset($yes)
                                        ...
                                        <div class="d-flex justify-content-between mt-2 align-items-center">
                                            ...
                                            <span id="product-tax" class="text-13-black text-right"> 
                                                @isset($yes)
                    ...
                    <div class="col-12 col-xl-3 col-lg-12 col-sm-12 col-md-12 p-0 border">
                        <div id="show_info_Guest" style="height:100vh;">
                                    ...
                                    <div id="myUL"
                                        ...
                                        <ul class="m-0 p-0 scroll-data">
                                            <li class="p-2 align-items-center text-wrap"
                                                ...
                                                <a href="#" title="" style="flex:2" id="" name="search-info"
                                                    class="search-info">
                            ...
                            <div class="">
                                <div class="content-info--common" id="show-info-guest">
                                    <ul class="p-0 m-0">
                                        ...
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                            style="height:44px;">
                                            <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Mã Giao
                                                Hàng</span>
                                            <input class="text-13-black w-50 border-0 bg-input-guest"
                                        ...
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                            ...
                                            <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Đơn vị vận
                                                chuyển</span>
                                            <input class="text-13-black w-50 border-0 bg-input-guest "
                                                placeholder="Chọn thông tin" name="" id="" style="flex:2;" />
                                        </li>
                                        <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                            style="height:44px;">
                                            <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Phí giao
                                                hàng</span>
                                            <input class="text-13-black w-50 border-0 bg-input-guest "
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (Array.isArray(data) && data.length > 0) {
                            ...
                            soTonKho.text(parseFloat(productData.product_inventory == null ? 0 : productData.product_inventory));
                            if (productData.product_inventory > 0) {
                                $('.inventory').show();
                                $('.transaction').show();
                            }

                            // Cập nhật ID của hàng (row)
                            var newRowID = 'dynamic-row-' + productData.id;
                            $(this).closest('tr').attr('id', newRowID);
                            var dataTarget = '#exampleModal' + productData.id;
                            currentRow.find('.add-seri-number').attr('data-target', dataTarget);
                            var dataProduct = '#exampleModal' + productData.id;
                            currentRow.find('.add-seri-number').attr('data-target', dataTarget);
                            ...
                            if (seriProArray && seriProArray.length > 0 && seriProArray[0] !== null) {
                                currentRow.find('.open-modal-btn').removeClass('d-none');
                                currentRow.find(`.check-add-sn`).prop('disabled', true);
                            } else {
                                currentRow.find('.open-modal-btn').addClass('d-none');
                                currentRow.find(`.check-add-sn`).prop('disabled', false);
                            }
                                            ...
                                            $('.check-item').on('change',function() {
                                                        ...
                                                        if (checkedCheckboxes >qty_enter) {
                                                            ...
                                                            if ($(this ).is( ':checked' )) {
                                                                ...
                                                                if (selectedSerialNumbers[productId]) {
                                                                    selectedSerialNumbers[productId] = selectedSerialNumbers[productId]
                            ...
                            if (productData.check_seri == 1) {
                                currentRow.find(`.check-add-sn`).prop('checked', true);
                            } else {
                                currentRow.find(`.check-add-sn`).prop('checked', false);
                            }
                            //Kiểm tra đã thêm seri chưa
                            $('#luuNhap').off('click').on('click',
                                function(e) {
                                    var insufficientSeriProducts = [];
                                    $(".bg-white.addProduct")
                                        .each(function() {
                                            var checkbox =$(this).find(".check-add-sn");
                                            // Trường hợp chọn seri
                                            if (checkbox.prop("checked") && checkbox.prop("disabled")) {
                                                var quantityValue =parseFloat($(this).find(".quantity-input").val());
                                                var productId = $(this) .find(".product_id").val();
                                                var productName =$(this).find( ".product_name").val();

                                                for (var i = 0; i < quantityValue; i++ ) {
                                                    var isSeriInputExist =
                                                        $(`input[name="selected_serial_numbers[]"][data-product-id="${productId}"]:eq(${i})`).length > 0;
                                                    if (!isSeriInputExist) {
                                                        insufficientSeriProducts.push(productName);
                                                        break;
                                                    }
                                                }
                                            }
                                    ...
                                    if (insufficientSeriProducts.length > 0) {
                                        alert(`Số lượng "seri" không đủ cho các sản phẩm: ${insufficientSeriProducts.join(", ")}`);
                                        e.preventDefault();
                                    } else {
                                        var allFieldsFilled = true;
                                        $('.addProduct').each(function() {
                                                var productName = $(this).find('.product_name').val();
                                                var productUnit = $(this).find('.product_unit').val();
                                                var productQty = $(this).find('.quantity-input').val();

                                                if (productName === '' ||productUnit === '' ||productQty === '') {
                                                    allFieldsFilled= false;
                                                    return false;
                                                }
                                            });
                                        if (allFieldsFilled) {
                                            $('.check-add-sn:checked[disabled]').prop('disabled',false);
                                        } else {
                                            console.log('Vui lòng điền đầy đủ thông tin cho mỗi sản phẩm.');
                                        }
                                    }
                                });
                            $('#giaoHang').off('click').on('click',
                                function(e) {
                                    ...
                                    $(".bg-white.addProduct").each(
                                        function() {
                                            var soTonKho = parseFloat($(this).find(".soTonKho").text());
                                            var checkbox = $(this).find(".check-add-sn");

                                            var quantity = parseFloat($(this).find(".quantity-input").val());
                                            var productNameInventory = $(this).find(".product_name").val();

                                            // Kiểm tra số lượng tồn kho
                                            if (quantity > soTonKho) {
                                                invalidInventoryProducts.push(productNameInventory);
                                            }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, item) {
                            ...
                            $("#total-amount-sum").text(formatCurrency(
                                totalPrice));
                            ...
                            $("#voucher").val(formatCurrency(item
                                ...
                                .discount));
                            $("#transport_fee").val(formatCurrency(item
                                .transfer_fee == null ? 0 : item
                                .transfer_fee));
                            var newRow = `
                            ...
                            //Check S/N
                            var rowId = $(this.currentTarget).closest(
                                'tr').attr('id');
                            var seriList = item.seri_pro.filter(item =>
                                item !== null).join('</li><li>');
                            var seriProElement = $(
                            ...
                            if (seriList.length > 0) {
                                rowElement.find(`.check-add-sn`).prop(
                                    'disabled', true);
                                seriProElement.hide();
                            } else {
                                seriProElement.html(
                            ...
                            $('#luuNhap').off('click').on('click',
                                function(e) {
                                    ...
                                    $(".bg-white.addProduct")
                                        .each(function() {
                                            var checkbox = $(this).find(".check-add-sn");
                                            var isCheckedAndNotDisabled = checkbox.prop("checked") && ! checkbox.prop("disabled");
                                            // Trường hợp chọn seri
                                            if (checkbox.prop("checked") && checkbox.prop("disabled")) {
                                                var quantityValue = parseFloat($(this).find(".quantity-input").val());
                                                var productId =$(this).find(".product_id").val();

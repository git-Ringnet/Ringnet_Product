                    ...
                    <div class="row m-0">
                        ...
                        <div class="dropdown">
                            <button type="button" data-toggle="dropdown"
                                ...
                                <p class="m-0 p-0 text-13">Lưu và in</p>
                            </button>
                            <div class="dropdown-menu" style="z-index: 9999;">
                        ...
                        <button type="submit" name="action" value="1"
                            ...
                            <p class="m-0 p-0 text-13">Lưu nháp</p>
                        </button>
                        <div class="dropdown">
                    ...
                    <div class="d-flex w-100">
                        {{-- <div
                            ...
                            <span class="text-13 text-nowrap mr-3" style="flex: 1.5;">Người đại
                                diện</span>
                            <input class="text-13-black w-50 border-0 bg-input-guest input-search bg-input-guest-blue"
                                ...
                                <table class="table table-hover bg-white rounded" id="inputcontent">
                                    <thead>
                                        <tr style="height:44px;">
                                            ...
                                            <th class="border-right p-0 px-2 text-13 text-left" style="">Tên
                                                sản
                                                phẩm</th>
                                            <th class="border-right p-0 px-2 text-13 text-left" style="">Đơn
                                                vị
                                            </th>
                                ...
                                <div class="position-relative col-lg-5 col-md-7 col-sm-12 margin-left180">
                                    <div class="m-3 ">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            ...
                                            <input type="hidden" name="totalValue" value="0"id="total">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                ...
                                                STT</th>
                                            <th class="border border-left-0 border-top-0 py-1 text-secondary">
                                                Serial
                                                number</th>
                                        </tr>
                                    </thead>
...
<script>
    ...
    $(document).ready(function() {
                        ...
                        <td class="border-bottom">
                            ...
                            if (checkProductTaxValues()) {
                                ...
                                if (!isNaN(commonTaxRate)) {
                                    totalTax1 = grandTotal * (commonTaxRate /
                                        100);
                                }
                            }
                            grandTotal = grandTotal + totalTax1;
        ...
        var convert = getQueryParam('convert');
        if (convert) {
            $.ajax({
                url: '{{ route('getInfoQuote') }}',
                type: 'GET',
    ...
    function calculateTotals() {
        ...
        checkProductTaxValues();
        if (checkProductTaxValues()) {
            var commonTaxRate = parseFloat($('input[name="product_tax[]"]').first().val());
            if (!isNaN(commonTaxRate)) {

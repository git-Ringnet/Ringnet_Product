    ...
    <div class="d-flex justify-content-between align-items-center pl-4 ml-1">
        <div class="container-fluided">
            <div class="mb">
                ...
                <span class="font-weight-bold text-secondary">Đơn giao hàng</span>
            </div>
        </div>
                            ...
                            <table id="example2" class="table table-hover">
                                <thead class="sticky-head">
                                    <tr>
                                        ...
                                        <th class="border-top-0 bg-white pl-0 my-0 py-2"><input type="checkbox" name="all"
                                                id="checkall"></th>
                                            ...
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="id"
                                                    ...
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Mã giao hàng#</span>
                                                    </button>
                                                </a>
                                        ...
                                        <th scope="col" class="border-top-0 my-0 py-2">
                                            <span class="d-flex justify-content-start">
                                                <a href="#" class="sort-link" data-sort-by="created_at"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Đơn vị vận chuyển</span>
                                                    </button>
                                                </a>
                                                <div class="icon" id="icon-created_at"></div>
                                            </span>
                                        ...
                                        <th scope="col" class="border-top-0 my-0 py-2">
                                            <span class="d-flex justify-content-start">
                                                <a href="#" class="sort-link" data-sort-by="created_at"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Phí giao hàng</span>
                                                    </button>
                                                </a>
                                                <div class="icon" id="icon-created_at"></div>
                                            </span>
                                        ...
                                        <th scope="col" class="border-top-0 my-0 py-2">
                                            <span class="d-flex justify-content-center">
                                                <a href="#" class="sort-link" data-sort-by="total"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Ngày giao hàng</span>
                                                    </button>
                                                </a>
                                                <div class="icon" id="icon-total"></div>
                                            </span>
                                ...
                                <tbody>
                                    @foreach ($delivery as $item_delivery)
                                        <tr class="position-relative" onclick="handleRowClick('checkbox', event);">
                                            <td class="pr-0 py-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="6" class="mb-1" height="10" viewBox="0 0 6 10" fill="none">

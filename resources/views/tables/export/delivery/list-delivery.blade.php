        ...
        <div class="content__header--inner">
            ...
            <div class="pl-3 d-flex align-items-center">
                ...
                <div class="dropdown mx-2 filter-all">
                    ...
                    <x-filter-status name="status" key1="1" value1="Nháp" key2="2" value2="Đã giao"
                                ...
                                <table id="example2" class="table table-hover">
                                                ...
                                                <span class="d-flex justify-content-start">
                                                    <a href="#" class="sort-link btn-submit"
                                                        data-sort-by="ngayGiao" data-sort-type="DESC"><button
                                                            class="btn-sort text-14" type="submit">Ngày lập</button>
                                                    </a>
                                                ...
                                                <span class="d-flex justify-content-start">
                                                    <a href="#" class="sort-link btn-submit"
                                                        data-sort-by="guest_name" data-sort-type="DESC"><button
                                                            class="btn-sort text-14" type="submit">Khách
                                                            hàng</button>
                                                    </a>
                                    ...
                                    <tbody class="tbody-delivery">
                                        @foreach ($deliveries as $item_delivery)
                                            <tr class="position-relative delivery-info height-30"
                                                onclick="handleRowClick('checkbox', event);">
                                                <input type="hidden" name="id-delivery" class="id-delivery"
                                                    id="id-delivery" value="{{ $item_delivery->maGiaoHang }}">
                                                <td class="text-13-black text-left border-bottom border-top-0 py-0">
                                                ...
                                                <td
                                                    class="text-13-black max-width120 text-left border-bottom border-top-0 py-0">
                                                ...
                                                @endcan
                                                <td class="text-13-black text-center border-bottom border-top-0 py-0">

        ...
        <div class="content-header-fixed p-0">
            <div class="content__header--inner">
                <div class="content__heading--left opacity-0">
                    ...
                    <span class="nearLast-span">Trả hàng NCC</span>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="d-flex content__heading--right">
                    <div class="row m-0">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="z-index: 9999;">
                                <a class="dropdown-item text-13-black" href="#"
                                    onclick="printContentImport('printContent')">Phiếu trả hàng</a>
                            </div>
                        </div>
                        <label class="btn-destroy btn-light d-flex align-items-center h-100 m-0 mx-1">
                            ...
                            <p class="m-0 p-0 text-13">Đính kèm</p>
                        ...
                        <div class="d-flex w-100">
                            <div
                                ...
                                <input type="text" placeholder="Nhập thông tin" readonly
                                    class="text-13-black w-50 border-0 bg-input-guest nameGuest px-2 py-2 flatpickr-input"
                                    style="flex:2;"
                                    value="{{ date_format(new DateTime($returnImport->created_at), 'd/m/Y') }}" />
                            </div>
                            <div
                                class="d-flex w-100 justify-content-between py-2 px-3 border align-items-center text-left text-nowrap position-relative height-44">
                                                ...
                                                @foreach ($product as $item)
                                                    <tr class="bg-white" style="height:80px;">
                                                        ...
                                                        <td
                                                            ...
                                                            <div class='mt-3 text-13-blue transaction text-right'>Giao
                                                                dịch
                                                                gần
                                                                đây</div>
                                                        </td>

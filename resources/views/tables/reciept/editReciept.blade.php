        ...
        <section class="content-header p-0">
            <div class="container-fluided">
                ...
                <div class="row m-0 mb-1">
                    ...
                    <a href="#" id="delete_reciept" class="d-flex align-items-center h-100 btn-danger"
                                    ...
                                    <input type="text" placeholder="Nhập thông tin" name="delivery_charges"
                                        ...
                                        value="{{ $reciept->delivery_charges }}">
                                            ...
                                            <div class="d-flex ml-2 align-items-center">
                                                ...
                                                <input required type="date" placeholder="Nhập thông tin"
                                                    name="date_bill"
                                                    class="border border-top-0 w-100 py-2 border-left-0 border-right-0 px-3"
                                                    @if ($reciept->status == 2) readonly @endif
                            ...
                            <table class="table table-hover bg-white rounded" id="inputcontent">
                                ...
                                <tbody>
                                    @foreach ($product as $item)
                                        <tr class="bg-white">
                                            <td class="border border-left-0 border-top-0 border-bottom-0"><input

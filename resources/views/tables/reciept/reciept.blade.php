    ...
    <div class="content-header-fixed p-0 margin-250 border-bottom-0">
        <div class="content__header--inner margin-left32">
            ...
            <div class="d-flex content__heading--right">
                <div class="row m-0">
                    <a href="{{ route('reciept.create', $workspacename) }}" class="user_flow mr-3" data-type="HDMH"
                        data-des="HDMH">
                            ...
                            <div class="col-md-5 d-flex align-items-center">
                                ...
                                <div class="dropdown mx-2 filter-all">
                                    ...
                                    <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                        ...
                                        <div class="scrollbar">
                                            <button class="dropdown-item btndropdown text-13-black" id="btn-number_bill"
                                                data-button="number_bill" type="button">Số
                                                hoá đơn
                                            </button>
                                ...
                                <table id="example2" class="table table-hover">
                                    <thead class="sticky-head">
                                        <tr>
                                            ...
                                            <th scope="col" class="height-52 border-bottom" style="width: 18%;">
                                                <span class="d-flex">
                                                    <a href="#" class="sort-link btn-submit"
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.filters.length > 0) {
                    $('.result-filter-reciept').addClass('has-filters');
                } else {
                    $('.result-filter-reciept').removeClass('has-filters');
                }

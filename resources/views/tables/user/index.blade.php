            ...
            <div class="d-flex align-items-center pl-3">
                ...
                <div class="dropdown mx-2 filter-all">
                    ...
                    <div class="dropdown-menu" id="dropdown-menu"
                        ...
                        <x-filter-text name="code" title="Mã" />
                        <x-filter-text name="name" title="Tên" />
                        ...
                        <div class="outer2 table-responsive text-nowrap">
                            <table id="example2" class="table table-hover bg-white rounded">
                                <thead class="border-custom">
                                    <tr class="height-30">
                                        <th class="height-30 border py-0" scope="col" style="">
                                        ...
                                        <th class="height-30 border py-0" scope="col" style="">
                                            <span class="d-flex justify-content-start">
                                                <a href="#" class="sort-link btn-submit"
                                                    ...
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-14">Mã</span>
                                                    </button>
                                                </a>
                                                <div class="icon"></div>
                                            </span>
                                        </th>
                                        <th class="height-30 border border-bottom-0 py-0" scope="col" style="">
                                            <span class="d-flex justify-content-start">
                                                <a href="#" class="sort-link btn-submit"
                                                    data-sort-by="group_type" data-sort-type="DESC">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-14">Tên</span>
                                                    </button>
                                                </a>
                                                <div class="icon"></div>
                                            </span>
                                    ...
                                    @foreach ($users as $item)
                                        <tr class="position-relative user-info height-30">
                                            <input type="hidden" name="id-user" class="id-user" id="id-user"
                                                value="{{ $item->id }}">
                                            <td class="text-13-black border border-top-0 py-0">
                                                {{ $stt++ }}
                                            </td>
                                            <td class="text-13-black border border-top-0 py-0">{{ $item->user_code }}
                                            </td>
                                            ...
                                            <td class="position-absolute m-0 p-0 border-0 bg-hover-icon icon-center">
                                                <div class="d-flex w-100">
                                                    ...
                                                    <a class="activity" data-name1="KH"
                                                        ...
                                                        href="{{ route('users.edit', ['workspace' => $workspacename, 'user' => $item->id]) }}">
                                                        <div class="m-0 px-2 py-1 mx-2 rounded">
                                                    ...
                                                    <a href="#">
                                                        <div class="rounded">
                                                            <form
                                                                ...
                                                                action="{{ route('users.destroy', ['workspace' => $workspacename, 'user' => $item->id]) }}"
...
<script type="text/javascript">
    $(document).on('click', '.btn-submit', function(e) {
        ...
        var formData = {
            ...
            code: getData('#code', this), // Lấy dữ liệu từ trường Mã
            name: getData('#name', this), // Lấy dữ liệu từ trường Tên
            address: getData('#address', this), // Lấy dữ liệu từ trường Địa chỉ
            phone: getData('#phone', this), // Lấy dữ liệu từ trường Điện thoại
            email: getData('#email', this), // Lấy dữ liệu từ trường Email
        ...
        $.ajax({
            ...
            success: function(data) {
                updateFilters(data, filters, '.result-filter-user', '.tbody-user',
                    '.user-info',
                    '.id-user', $(this).data('button'));
            }
        });
        $.ajaxSetup({
            headers: {

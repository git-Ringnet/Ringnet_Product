        ...
        <div class="content-header-fixed p-0">
            <div class="content__header--inner">
                <div class="content__heading--left text-long-special">
                    ...
                    <span>
                        <a class="text-dark" href="{{ route('users.index', $workspacename) }}">Nhân viên</a>
                    </span>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                ...
                <div class="d-flex content__heading--right">
                    <div class="row m-0">
                        <div class="dropdown">
                            <a href="{{ route('users.index', $workspacename) }}" class="activity" data-name1="KH"
                                data-des="Hủy">
                ...
                <div class="container-fluided">
                    ...
                    <div class="info-chung">
                        <div class="content-info">
                            ...
                            <div class="d-flex align-items-center height-60-mobile">
                                <div class="title-info height-100 py-2 border border-top-0 border-left-0">
                                    <p class="p-0 m-0 margin-left32 text-13-red required-label">Email(Tài khoản đăng
                                        nhập)</p>
                                </div>

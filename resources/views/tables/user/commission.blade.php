                        ...
                        <div class="card">
                            ...
                            <div class="outer2 text-nowrap">
                                <table id="example2" class="table table-hover bg-white rounded">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="11" class="border-bottom bold">Nhóm đối tượng:
                                                Chưa chọn nhóm</td>
                                        </tr>
                                        ...
                                        @foreach ($users as $item)
                                            @if ($item->group_id == 0)
                                                <tr>
                                                    ...
                                                    <td colspan="10" class="border-bottom bold">Nhân viên:
                                                        {{ $item->name }}</td>
                                                </tr>
                                                @php
                                                    $totalDeliverQty = 0;
                                                    ...
                                                    @if ($matchedItems->isNotEmpty())
                                                        ...
                                                        @foreach ($matchedItems as $matchedItem)
                                                            ...
                                                            <tr class="position-relative relative">
                                                                ...
                                                                <td class="text-13-black height-52 border">
                                                                    <input type="text" autocomplete="off"
                                                                        class="border-0 px-2 py-1 w-100 number commission_total height-32"
                                                                        data-sale="{{ $item->id }}"
                                                                        data-quote="{{ $matchedItem->id_quote }}"
                                                                        data-month="{{ $itemDelivery->ngayTao }}"
                                                                        value="{{ number_format($matchedItem->commission) }}"
                                        ...
                                        @foreach ($groupUsers as $value)
                                            <tr>
                                                <td colspan="11" class="border-bottom bold">Nhóm nhân viên:
                                                    {{ $value->name }}</td>
                                            </tr>
                                            @foreach ($users as $item)

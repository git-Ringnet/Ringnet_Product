        ...
        <section class="content-header p-0">
            <div class="container-fluided">
                ...
                <div class="row m-0 mb-1">
                    ...
                    <button class="btn-option" style="margin-right:10px">
                        ...
                        @foreach ($product as $item)
                            <tr class="bg-white">
                                <td class="border border-left-0 border-top-0 border-bottom-0">
                                    <input type="hidden" readonly value="{{ $item->id }}" name="listProduct[]">
                                    <div
                                        ...
                                        <input type="text" name="product_code[]"
                                            ...
                                            value="{{ $item->getProductCode->product_code }}">
                                ...
                                <td class="border border-top-0 border-bottom-0 product-ratio">
                                    <input required type="text" name="product_ratio[]"
                                ...
                                <td class="border border-top-0 border deleteRow"><svg width="24" height="24"

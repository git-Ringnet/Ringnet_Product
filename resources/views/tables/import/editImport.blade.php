                        ...
                        @foreach ($product as $item)
                            <tr class="bg-white">
                                ...
                                <td class="border border-top-0 border-bottom-0">
                                    <input type="text" name="product_name[]" class="border-0 px-3 py-2 w-100"
                                        value="{{ $item->product_name }}">
                                </td>
                                <td class="border border-top-0 border-bottom-0">
                                    <input type="text" name="product_unit[]" class="border-0 px-3 py-2 w-100"
                                        value="{{ $item->product_unit }}">
                                </td>
                                <td class="border border-top-0 border-bottom-0 border-right-0">
                                    <input type="text" name="product_qty[]" class="border-0 px-3 py-2 w-100"
                                        value="{{ $item->product_qty }}">
                                </td>
                                <td class="border border-top-0 border-bottom-0 border-right-0">
                                    <input type="text" name="price_import[]" class="border-0 px-3 py-2 w-100"
                                ...
                                <td class="border border-top-0 border-bottom-0 border-right-0">
                                    <input type="text" name="total_price[]" class="border-0 px-3 py-2 w-100"

...
<div class="content-wrapper">
    ...
    {{-- <form action="{{ route('import.edit', $import->id) }}" method="GET"> --}}
    {{-- @csrf --}}
                    ...
                    <div class="info-chung">
                        ...
                        <div class="content-info">
                            ...
                            <div class="d-flex ml-2 align-items-center">
                                ...
                                <input readonly type="text" placeholder="Nhập thông tin" name="quotation_number"
                            ...
                            <div class="d-flex ml-2 align-items-center">
                                ...
                                <input readonly type="text" placeholder="Nhập thông tin" name="reference_number"
                                    class="border border-top-0 w-100 py-2 border-left-0 border-right-0 px-3"
                            ...
                            <div class="d-flex ml-2 align-items-center">
                                ...
                                <input readonly type="date" placeholder="Nhập thông tin" name="date_quote"
                                    class="border border-top-0 w-100 py-2 border-left-0 border-right-0 px-3"
                            ...
                            <div class="d-flex ml-2 align-items-center">
                                ...
                                <input readonly type="text" placeholder="Nhập thông tin" name="price_effect"
                            ...
                            <div class="d-flex ml-2 align-items-center">
                                ...
                                <input readonly type="text" placeholder="Nhập thông tin" name="terms_pay"
                                    class="border border-top-0 w-100 py-2 border-left-0 border-right-0 px-3"
                            ...
                            <div class="d-flex ml-2 align-items-center position-relative">
                                ...
                                <input readonly id="" required type="text" placeholder="Nhập thông tin"
                        ...
                        <tbody>
                            @foreach ($product as $item)
                                <tr class="bg-white">
                                    ...
                                    <td class="border border-top-0 border-bottom-0 border-right-0">
                                        <select name="product_tax[]" id="" class="product_tax" disabled>
                                            <option value="0" @if ($item->product_tax == 0) selected @endif>0%
                                            </option>
                                            <option value="8" @if ($item->product_tax == 8) selected @endif>8%
                                            </option>
                                            <option value="10" @if ($item->product_tax == 10) selected @endif>
                                                10%
                                            </option>
                                            <option value="99" @if ($item->product_tax == 99) selected @endif>
                                                NOVAT
                                            </option>
                                        </select>
                                    </td>
                        ...
                        <tbody>
                            ...
                            @foreach ($history as $item)
                                <tr class="bg-white">
                                    ...
                                    <td class="border border-top-0 border-bottom-0">
                                        <input type="text" class="border-0 px-3 py-2 w-100 product_unit" readonly
                                            value="{{ $item->product_unit }}">
                                    </td>
                                    <td class="border border-top-0 border-bottom-0 border-right-0">
                                        <input type="text" class="border-0 px-3 py-2 w-100 quantity-input" readonly
                                            value="{{ fmod($item->product_qty, 2) > 0 ? number_format($item->product_qty, 2, '.', ',') : number_format($item->product_qty) }}">
                                    </td>
                                    <td class="border border-top-0 border-bottom-0 border-right-0">
                                        <input type="text" class="border-0 px-3 py-2 w-100 price_export" readonly
                                            value="{{ fmod($item->price_export, 2) > 0 ? number_format($item->price_export, 2, '.', ',') : number_format($item->price_export) }}">
                                    </td>
                                    <td class="border border-top-0 border-bottom-0 border-right-0">
                                        <input type="text" class="product_tax border-0 px-3 py-2 w-100" readonly
                                            value="{{ $item->product_tax }}">
                                    </td>
                                    <td class="border border-top-0 border-bottom-0 border-right-0">
                                        <input type="text" class="border-0 px-3 py-2 w-100 total_price" readonly
                                            value="{{ fmod($item->product_total, 2) > 0 ? number_format($item->product_total, 2, '.', ',') : number_format($item->product_total) }}">
                                    </td>
                                    <td class="border border-bottom-0 p-0 bg-secondary"></td>
                                    <td class="border border-top-0 border-bottom-0">

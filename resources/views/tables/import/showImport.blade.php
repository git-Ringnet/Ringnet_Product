                    ...
                    <div class="row m-0">
                                    ...
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" style="flex:2;" onclick="getAction(this)"
                                            ...
                                            <button class="align-items-left h-100 border-0 w-100 rounded" 
                                                ...
                                                <span style="font-weight: 600;color: #000; font-size:13px">Thêm nhận hàng</span>
                                            </button>
                                        </a>
                                    </li>
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="#" style="flex:2;" onclick="getAction(this)" 
                                            ...
                                            <button class="align-items-left h-100 border-0 w-100 rounded " 
                                                ...
                                                <span style="font-weight: 600;color: #000; font-size:13px">Thêm mua hàng</span>
                                            </button>
                                        </a>
                                    </li>
                                    <li class="p-2 align-items-left text-wrap" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                        ...
                        <a href="#">
                            <button name="action"type="button"
                                id="delete_import" class="btn--remove d-flex align-items-center h-100" 
                                style="margin-right:10px">
                                <svg class="mx-1" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div class="container-fluided">
                    <div class="tab-content">
                        ...
                        <div id="history" class="tab-pane fade">
                            <div class="bg-filter-search border-top-0 text-center border-custom">
                                <p class="font-weight-bold text-uppercase info-chung--heading text-center">LỊCH SỬ MUA HÀNG</p>
                            </div>
                            <section class="content">
                                <div class="table-responsive text-nowrap order_content">
                                            ...
                                            @foreach ($history as $item)
                                                <tr class="bg-white">
                                                    ...
                                                    <td class='border-right p-2 text-13 align-top position-relative'>
                                                        <div class="d-flex align-items-center">
                                                            <input type="text"
                                                                class="searchProductName border-0 px-2 py-1 w-100" readonly
                                                                value="{{ $item->product_name }}">
                                                            <div class='info-product' data-toggle='modal' data-target='#productModal'> 
                                                                <svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 14 14' fill='none'>                                     
                                                                    <g clip-path='url(#clip0_2559_39956)'>                                         
                                                    ...
                                                    <td class='border-right p-2 text-13 align-top position-relative'>
                                                        <input type="text" class="border-0 px-2 py-1 w-100 text-right" readonly
                        ...
                        <ul class="p-0 m-0 ">
                                            ...
                                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left" style="height:44px;">
                                                ...
                                                <input type="text" class="text-13-black w-50 border-0"  
                                                        placeholder="Nhập thông tin" id="datePicker"

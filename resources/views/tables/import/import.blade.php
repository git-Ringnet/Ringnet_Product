                                    ...
                                    <thead class="sticky-head">
                                        <tr>
                                            ...
                                            <th scope="col" class="height-52">
                                                    <span class="d-flex justify-content-start">
                                                        <a href="#" class="sort-link" data-sort-by="total"
                                                            data-sort-type=""><button class="btn-sort text-13" type="submit">Nhà cung câp</button>
                                                        </a>
                                            ...
                                            <th scope="col" class="height-52">
                                                    <span class="d-flex">
                                                        <a href="#" class="sort-link" data-sort-by="total"
                                                            data-sort-type=""><button class="btn-sort text-13" type="submit">Nhận hàng</button>
                                                        </a>
                                                        <div class="icon" id="icon-total"></div>
                                                    </span>
                                            </th>
                                        ...
                                        @foreach ($import as $item)
                                            <tr class="position-relative" style="height:44px;">
                                                <td class="text-13-black">
                                                    ...
                                                    <input type="checkbox" id="{{ $item->id }}" class="cb-element checkall-btn">
                                                </td>

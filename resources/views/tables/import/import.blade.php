...
<div class="menu"
    ...
    <p class="quickAction m-0 p-1  text-13-black" data-type="receive" data-toggle="modal"
    ...
    <p class="quickAction m-0 p-1  text-13-black" data-type="reciept" data-toggle="modal"
        data-target="#exampleModal">
        <span class="mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                fill="none">
    ...
    <p class="quickAction m-0 p-1  text-13-black" data-type="payorder" data-toggle="modal"
        data-target="#exampleModal">
        <span class="mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                fill="none">
        ...
        <span class="title_payment">Tạo thanh toán mua hàng</span>
    </p>
</div>

                        ...
                        <div class="info-chung">
                            ...
                            <div class="content-info">
                                ...
                                <div class="d-flex ml-2 align-items-center">
                                    ...
                                    <input type="text" placeholder="Nhập thông tin" name="project_id"
        ...
        <section class="content">
            <div class="container-fluided">
                <table class="table table-hover bg-white rounded" id="inputcontent">
                    <thead>
                        <tr>
                            <th class="border-bottom-0 border-right"><input type="checkbox"> Mã sản phẩm
                            </th>
                            <th class="border-bottom-0 border-right">Tên sản phẩm</th>
                            <th class="border-bottom-0 border-right">Đơn vị</th>
                            <th class="border-bottom-0 border-right">Số lượng</th>
                            <th class="border-bottom-0 border-right">Đơn giá</th>
                            <th class="border-bottom-0 border-right">Thuế</th>
                            <th class="border-bottom-0 border-right">Thành tiền</th>
                        ...
                        <tr class="bg-white">
                            <td class="border border-left-0 border-top-0 border-bottom-0">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    ...
                                    <input type="checkbox">
                                    <input type="text" name="product_code[]" class="border-0 px-3 py-2 w-75">
                                </div>
                            </td>
                            <td class="border border-top-0 border-bottom-0"><input type="text"
                                    name="product_name[]" class="border-0 px-3 py-2 w-100">
                            </td>
                            <td class="border border-top-0 border-bottom-0"><input type="text"
                                    name="product_unit[]" class="border-0 px-3 py-2 w-100">
                            </td>
                            <td class="border border-top-0 border-bottom-0 border-right-0"><input type="text"
                                    name="product_qty[]" class="border-0 px-3 py-2 w-100"></td>
                            <td class="border border-top-0 border-bottom-0 border-right-0"><input type="text"
                                    name="price_import[]" class="border-0 px-3 py-2 w-100"></td>
                            ...
                            <td class="border border-top-0 border-bottom-0 border-right-0"><input type="text"
                                    name="total_price[]" class="border-0 px-3 py-2 w-100"></td>
                            <td class="border border-top-0 border-bottom-0 border-right-0"><input type="text"
                                    name="product_note[]" class="border-0 px-3 py-2 w-100"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<script>
    ...
    $('#addProvide').click(function() {
        ...
        if (provide_code == '') {
            alert("Vui lòng nhập Mã só thuế");
            check = true;
            return false;
        }
        if (provide_address == '') {

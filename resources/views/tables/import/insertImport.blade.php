...
<script>
    ...
    function addRowTable() {
        var tr = '<tr class="bg-white">' +
            ...
            '<input type="text" id="searchProductName" class="searchProductName border-0 px-3 py-2 w-100" name="product_name[]">' +
            ...
            '<input type="text" class="border-0 px-3 py-2 w-100 product_unit" name="product_unit[]">' +
            '</td>' +
            '<td class="border border-top-0 border-bottom-0">' +
            ...
            '<input type="text" class="border-0 px-3 py-2 w-100 product_ratio" name="product_ratio[]">' +
            '</td>' +
            '<td class="border border-top-0 border-bottom-0 price-import">' +
            '<input type="text" class="border-0 px-3 py-2 w-100 price_import" name="price_import[]">' +
            '</td>' +
            '<td class="border border-top-0 border-bottom-0">' +

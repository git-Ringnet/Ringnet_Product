        ...
        <section class="content-header p-0">
            <div class="container-fluided">
                <div class="mb-3">
                    <span>Mua hàng</span>
                    <span>/</span>
                    <span class="font-weight-bold">Đơn mua hàng mới</span>
                </div>
                        ...
                        @isset($dataImport)
                            ...
                            @foreach ($dataImport as $item)
                                <tr class="bg-white">
                                    ...
                                    <td class="border border-top-0 border-bottom-0"><input type="text" required=""
                                            class="border-0 px-3 py-2 w-100 price_export" name="price_export[]"></td>

    ...
    <section class="content-header p-0">
        <div class="container-fluided">
            ...
            <div class="row m-0 mb-1">
                <a href="{{ route('nha-cung-cap.create') }}">
                                ...
                                <thead class="sticky-head">
                                    <tr>
                                        ...
                                        <th scope="col">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="id"
                                                    data-sort-type="#"><button class="btn-sort" type="submit">Tên
                                                    </button></a>
                                        ...
                                        <th scope="col">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="id"
                                                    data-sort-type="#"><button class="btn-sort" type="submit">Email
                                                    </button></a>
                                                <div class="icon" id="icon-id"></div>
                                            </span>
                                        </th>
                                        <th scope="col">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="id"
                                                    data-sort-type="#"><button class="btn-sort" type="submit">Điện thoại
                                                    </button></a>
                                                <div class="icon" id="icon-id"></div>
                                            </span>
                                        </th>
                                        <th scope="col">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="id"
                                                    data-sort-type="#"><button class="btn-sort" type="submit">Dư nợ
                                                    </button></a>
                                                <div class="icon" id="icon-id"></div>
                                            </span>
                                        </th>

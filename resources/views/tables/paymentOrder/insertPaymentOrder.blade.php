                        ...
                        success: function(product) {
                            ...
                            product.forEach(function(element) {
                                ...
                                <div class="d-flex align-item-center">
                                    <input value="` + formatCurrency(element.promotion) + `" type="text" name="promotion[]" class="text-right border-0 px-2 py-1 w-100 height-32 promotion" readonly autocomplete="off">
                            ...
                            if (data.discount_type == 1) {
                                total_tax = ((total - data.discount) * (product[
                                        0].product_tax == 99 ? 0 :
                                    product[0].product_tax)) / 100;
                                voucher = (total - data.discount + total_tax)
                            } else if (data.discount_type == 2) {
                                total_tax = (((total * data.discount) / 100) * (
                                    product[
                                        0].product_tax == 99 ? 0 :
                                    product[0].product_tax)) / 100;
                                voucher = ((total * data.discount) / 100) +
                                    total_tax;
                            } else {
                                voucher = total + total_tax;
                            }

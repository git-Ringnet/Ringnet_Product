...
<form action="{{ route('receive.update', ['workspace' => $workspacename, 'receive' => $receive->id]) }}" method="POST"
    ...
    <div class="content-wrapper1 py-0 border-bottom px-4">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="container-fluided">
                <div class="row m-0 mb-1">
                    ...
                    <a href="#" id="delete_receive" class="d-flex align-items-center h-100 btn-danger mr-2"
        ...
        <div class="content-wrapper1 py-0 pl-0 px-0 ml-0" id="main">
            ...
            <div class="tab-content">
                <section class="content tab-pane in active" id="info">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($product as $item)
                                                <tr class="bg-white">
                                                    ...
                                                    <td
                                                        class="border border-top-0 border-bottom-0 border-right-0 d-none">
                                                        <input type="text"
                        ...
                        <div id="show_info_Guest">
                            ...
                            <div class="d-flex align-items-center justify-content-between border py-2 px-1">
                                ...
                                <input id="search_quotation" type="text" placeholder="Nhập thông tin"
                                    ...
                                    readonly>
                                {{-- <ul id="listReceive"
                                class="bg-white position-absolute w-50 rounded shadow p-0 scroll-data list-guest"

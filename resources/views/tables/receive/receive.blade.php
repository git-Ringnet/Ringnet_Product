                                            ...
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="export_code"
                                                    ...
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Mã nhận hàng</span>
                                                    </button>
                                                </a>
                                        ...
                                        <th scope="col" class="border-top-0 bg-white my-0 py-2">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="export_code"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Đơn mua hàng</span>
                                                    </button>
                                                </a>
                                                <div class="icon" id="icon-export_code"></div>
                                            </span>
                                        ...
                                        <th scope="col" class="border-top-0 bg-white my-0 py-2">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="export_code"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Nhà cung cấp</span>
                                                    </button>
                                                </a>
                                                <div class="icon" id="icon-export_code"></div>
                                            </span>
                                        ...
                                        <th scope="col" class="border-top-0 bg-white my-0 py-2">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="export_code"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Phí nhận hàng</span>
                                                    </button>
                                                </a>
                                                <div class="icon" id="icon-export_code"></div>
                                            </span>
                                ...
                                <tbody>
                                    @foreach ($receive as $item)
                                        <tr class="position-relative">
                                            ...
                                            <td class="py-2">{{ number_format($item->delivery_charges) }}</td>
                                            <td class="py-2">
                                                @if ($item->status == 1)

                            ...
                            <div class="content-info">
                                <div class="d-flex ml-2 align-items-center position-relative">
                                    ...
                                    <input id="search_quotation" type="text" placeholder="Nhập thông tin"
                                        ...
                                        value="@isset($yes){{ $show_receive['quotation_number'] == null ? $show_receive['id'] : $show_receive['quotation_number'] }}@endisset">
                                    <ul id="listReceive"
            ...
            <div class="container-fluided">
                <table class="table table-hover bg-white rounded" id="inputcontent">
                    ...
                    <tbody>
                        @isset($receiver_bill)
                            {{-- @dd($receiver_bill); --}}
                            @foreach ($receiver_bill['quoteImport'] as $index => $element)
                                @if ($element->product_qty - ($element->receive_qty == null ? 0 : $element->receive_qty) > 0)
                                    <tr class="bg-white">
                                        ...
                                        <td class="border border-top-0 border-bottom-0 border-right-0">
                                            <div class="d-flex">
                                                <input
                                                    oninput="checkQty(this,{{ $element->product_qty - $element->receive_qty }})"
                                                    type="text" name="product_qty[]"
                                                    class="border-0 px-3 py-2 w-100 quantity-input"
                                                    value="{{ $element->product_qty - $element->receive_qty }}">
                                            </div>
                                        </td>
                                        <td class="border border-top-0 border-bottom-0 text-center">
                                            {{-- {{ $receiver_bill['checked'][$index] }} --}}
                                            <input onclick="getDataCheckbox(this)"
                                                type="checkbox"{{ $receiver_bill['checked'][$index] == 'endable' || $receiver_bill['cb'][$index] == 1 ? 'checked' : '' }}
                                                {{ $receiver_bill['checked'][$index] }}>
                                            <input type="hidden" name="cbSN[]"
                                                value="{{ $receiver_bill['checked'][$index] == 'endable' || $receiver_bill['cb'][$index] == 1 ? 1 : 0 }}">
                                        </td>
                                        ...
                                        <td class="border border-top-0 border deleteRow"><svg width="24"

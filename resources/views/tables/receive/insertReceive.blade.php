        ...
        <div class="content-header-fixed p-0 border-0">
            <div class="content__header--inner">
                <div class="content__heading--left">
                    ...
                    <span class="last-span">Tạo phiếu nhập kho</span>
                </div>
...
<script>
    ...
    $(document).on('click', '.search-info', function() {
        ...
        // Ẩn Đơn mua hàng
        $('.d-flex.justify-content-between.py-2.px-3.border-bottom.align-items-center.text-left.text-nowrap.position-relative')
                            ...
                            product.quoteImport.forEach((element, index) => {
                                if (element.product_qty - element
                                    ...
                                    var tr =
                                        `<tr class="bg-white position-relative" style="height:80px;">
                                                <td class="d-none border-top-0 border-bottom border-right bg-white align-top text-13-black" style="width:5%;padding-left: 2rem !important;">
                                                    <input type="hidden"  value="` + element.id + `" name="listProduct[]">
                                                    <input type="text"  name="product_code[]" class="border-0 py-1 w-75 searchProduct height-32" 
                                                        value="` + (element.product_code == null ? "" : element
                                            .product_code) + `">
                                                    <ul id="listProductCode" class="listProductCode bg-white position-absolute w-100 rounded shadow p-0 scroll-data" style="z-index: 99; left: 24%; top: 75%;">
                                                    </ul>
                                            ...
                                            "selected" : "") + `>NOVAT</option>
                                                ...
                                                <td class="d-none border-right p-2 text-13 align-top border-bottom border-top-0">
                                                    <input type="text" class="border-0 px-2 py-1 w-100 total_price text-right height-32" ="" name="total_price[]"
                                                    value="` + formatCurrency(promotionObject[
                                                'type'] == 1 ? (element
                                                .product_total -
                                                promotionObject['value']
                                            ...
                                            "") + `>
                                                ...
                                                <td class="p-2 note text-13 align-top border-top-0 border-bottom border-right">
                                                    <input  type="text" name="product_note[]" class="border-0 py-1 w-100 height-32" 
                                                        placeholder='Nhập ghi chú'
                                                        value="` + (element.product_note == null ? "" : element
                                            .product_note) + `">
                                                </td>

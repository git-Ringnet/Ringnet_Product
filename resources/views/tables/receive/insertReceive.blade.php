                ...
                <div class="d-flex content__heading--right">
                    <div class="row m-0">
                        ...
                        <a href="#" onclick="getAction(this)">
                            <button name="action" value="action_1" type="submit" class="custom-btn d-flex align-items-center h-100"
                                ...
                                <thead>
                                        <tr style="height:44px;">
                                                    ...
                                                    <th scope="col" class="border">
                                                        <span class="d-flex">
                                                            <a href="#" class="sort-link" data-sort-by="total"
                                                                data-sort-type=""><button class="btn-sort text-13" type="submit">Quản lý SN</button>
                                                            </a>
                                                            <div class="icon" id="icon-total"></div>
                                                        </span>
                                                    </th>
        ...
        <div class="content-wrapper2 px-0 py-0">
            <div id="mySidenav" class="sidenav border">
                <div id="show_info_Guest">
                    ...
                    <div class="d-flex justify-content-between py-2 px-3 border align-items-center text-left text-nowrap position-relative" style="height:49px;">
                                ...
                                @foreach ($listDetail as $value)
                                    <li class="p-2 align-items-center" style="border-radius:4px;border-bottom: 1px solid #d6d6d6;">
                                        <a href="javascript:void(0)" id="{{ $value->id }}" 
                                            name="search-info" class="search-receive" style="flex:2;">
                                                <span class="text-13-black">{{ $value->quotation_number == null ? $value->id : $value->quotation_number }}</span>
                                        </a>
                    ...
                    <div id="more_info" style="display:none;">
                        <ul class="p-0 m-0">
                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                ...
                                <input type="text" class="text-13-black w-50 border-0 bg-input-guest nameGuest" style="flex:2;" readonly 
                                        id="provide_name" value="@isset($yes){{ $show_receive['provide_name'] }}@endisset"
                            ...
                            <li class="d-flex justify-content-between py-2 px-3 border align-items-center text-left"
                                ...
                                <input type="text" class="text-13-black w-50 border-0 bg-input-guest nameGuest" style="flex:2;"
                                        id="represent" readonly name="represent" placeholder="Chọn thông tin"/>
                            </li>
                                        ...
                                        `<tr class="bg-white position-relative" style="height:80px;">
                                                ...
                                                <td class="border-right p-2 text-13 align-top" width: 15%;>
                                                    <div>
                                                        <input oninput="checkQty(this,` + (element.product_qty - element.receive_qty) +`)" 
                                                                ...
                                                                value="` + formatCurrency(element.product_qty - element.receive_qty) +`">
                                                ...
                                                <td class="border-right p-2 text-13 align-top text-center">
                                                    <div style="margin-top: 6px;">
                                                        <input onclick="getDataCheckbox(this)" 
                                                            type="checkbox" ` + (product.checked[index] == 'endable' || product.cb[index] == 1 ? 'checked' : '') + ` ` + (
                                                            product.checked[index]) + ` >
                                                        <input type="hidden" name="cbSeri[]" 
                                                                value="` + (product.checked[index] == 'endable' || product.cb[index] == 1 ? 1 : 0) +`">
                                                    </div>
                                                </td>
                                                ...
                                                <td class="border-right p-2 note text-13 align-top">
                                                    <input readonly type="text" name="product_note[]" class="border-0 py-1 w-100" 
                                                        ...
                                                        value="` + (element.product_note == null ? "" : element.product_note) + `">
                                                </td>

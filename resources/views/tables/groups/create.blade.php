<x-navbar :title="$title" activeGroup="groups" activeName="groups" :workspacename="$workspacename"></x-navbar>
<form action="{{ route('groups.store', $workspacename) }}" method="POST"
        ...
        <div class="content-header-fixed p-0 margin-250">
            <div class="content__header--inner margin-left32">
                <div class="content__heading--left text-long-special">
                    ...
                    <span>
                        <a class="text-dark" href="{{ route('groups.create', $workspacename) }}">Nhóm đối tượng</a>
                    </span>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                    ...
                    <div class="info-chung">
                        <div class="content-info">
                            ...
                            <div class="d-flex  align-items-center height-60-mobile">
                                ...
                                <select name="grouptype_id" required
...
<script>
    ...
    $("#add-field-btn").click(function() {
        ...
        const option = $(
            "<td class='border border-top-0 border-right-0 text-left' data-name1='KH' data-des='Xóa người đại diện'>" +

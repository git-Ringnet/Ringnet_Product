    ...
    <div class="content-header-fixed p-0 m-0">
        <div class="content__header--inner margin-left32">
            <div class="content__heading--left text-long-special">
                ...
                <span class="font-weight-bold">Xem nhóm sản phẩm</span>
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div class="d-flex content__heading--right">
                <div class="row m-0">
                    <div class="dropdown">
                        <a href="{{ route('groups.index') }}" class="activity" data-name1="SP"
                    ...
                    <a href="{{ route('groups.edit', $group->id) }}" class="activity" data-name1="SP"
                ...
                <div class="info-chung">
                    <div class="content-info">
                        <div class="d-flex align-items-center height-60-mobile">
                            ...
                            <input type="text" placeholder="Nhập thông tin" value="{{ $group->name }}" disabled
                            ...
                            @foreach ($products as $item)
                                @if ($item->group_id == $group->id)
                                    <div class="d-flex align-items-center py-2">
                                        <input type="checkbox" class="p-0 m-0 margin-left32 text-13-black" disabled checked
                                            value="{{ $item->id }}">

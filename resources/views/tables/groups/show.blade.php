...
<form action="#" method="POST" id="formSubmit" enctype="multipart/form-data">
    ...
    <input type="hidden" name="detail_id" value="{{ $group->id }}">
            ...
            <div class="content__header--inner margin-left32">
                <div class="content__heading--left">
                    ...
                    <span class="nearLast-span">
                        <a class="text-dark" href="{{ route('groups.index', ['workspace' => $workspacename]) }}">Khách
                            hàng
                        </a>
                    </span>
                    <span>
                ...
                <div class="d-flex content__heading--right">
                    <div class="row m-0">
                        <div class="dropdown">
                            <a href="{{ route('groups.index', ['workspace' => $workspacename]) }}" class="activity"
                        ...
                        <a class="activity" data-name1="KH" data-des="Xem trang sửa"
                            href="{{ route('groups.edit', ['workspace' => $workspacename, 'group' => $group->id]) }}">
        ...
        <div class="content editgroup" style="margin-top: 7.5rem;">
            <div class="tab-content mt-3">
                <div id="info" class="content tab-pane in active">
                    ...
                    <div class="content-info">
                        <div class="d-flex align-items-center height-60-mobile">
                            ...
                            <input type="text" required readonly name="group_name_display"
                                value="{{ $group->name }}"
                        ...
                        {{-- <div class="d-flex align-items-center height-60-mobile">
                            ...
                            <input type="text" name="group_code" value="{{ $group->group_code }}" readonly
                        ...
                        {{-- <div class="d-flex align-items-center height-60-mobile">
                            ...
                            <input type="text" required name="group_address" value="{{ $group->group_address }}"
                                readonly
                                class="border border-top-0 w-100 py-2 border-left-0 border-right-0 px-3 text-13-black height-100">
                        </div>
                        <div class="d-flex align-items-center height-60-mobile">
                            ...
                            <input type="text" name="key" value="{{ $group->key }}" readonly
                                class="border border-top-0 w-100 py-2 border-left-0 border-right-0 px-3 text-13-black height-100">
                        </div>
                        <div class="d-flex align-items-center height-60-mobile">
                            <div class="title-info py-2 border border-top-0 border-left-0 height-100">
                            ...
                            <input type="text" required name="group_email" value="{{ $group->group_name }}"
                                readonly
                                class="border border-top-0 w-100 py-2 border-left-0 border-right-0 px-3 text-13-black height-100">
                        </div> --}}
                    </div>
                                    ...
                                    @foreach ($historygroup as $itemgroup)
                                        <tr>
                                            ...
                                            <td class="text-13-black text-center border-bottom">
                                                ...
                                                @elseif ($itemgroup->status_receive === 3)
                                                    <svg width="16" height="16" viewBox="0 0 16 16"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                @elseif($itemgroup->status_receive === 2)
                                                    <svg width="16" height="16" viewBox="0 0 16 16"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <td class="text-center border-bottom">
                                                ...
                                                @elseif ($itemgroup->status_reciept === 3)
                                                    <svg width="16" height="16" viewBox="0 0 16 16"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g clip-path="url(#clip0_1699_20021)">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                ...
                                                @elseif($itemgroup->status_reciept === 2)
                                                    <svg width="16" height="16" viewBox="0 0 16 16"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15ZM11.7836 6.42901C12.0858 6.08709 12.0695 5.55006 11.7472 5.22952C11.4248 4.90897 10.9186 4.9263 10.6164 5.26821L7.14921 9.19122L5.3315 7.4773C5.00127 7.16593 4.49561 7.19748 4.20208 7.54777C3.90855 7.89806 3.93829 8.43445 4.26852 8.74581L6.28032 10.6427C6.82041 11.152 7.64463 11.1122 8.13886 10.553L11.7836 6.42901Z"
                                            ...
                                            <td class="text-13-black text-nowrap border-bottom">
                                                {{ number_format($itemgroup->total_price + $itemgroup->total_tax) }}
                                            </td>
                                            <td class="text-13-black text-nowrap border-bottom">
                                                {{ number_format($itemgroup->amount_owed) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                ...
                <div class="tab-pane fade" id="files">
                    ...
                    <x-form-attachment :value="$group" name="KH"></x-form-attachment>
                </div> --}}
            </div>
        </div>
    </div>

<x-navbar :title="$title" activeGroup="products" activeName="groups"></x-navbar>
        ...
        <div class="content-header-fixed p-0 m-0">
            <div class="content__header--inner margin-left32">
                <div class="content__heading--left text-long-special">
                    <span>
                        <a class="text-dark" href="{{ route('groups.index') }}">Nhóm sản phẩm</a>
                    </span>
                    <span>
                    ...
                    <span class="font-weight-bold">Sửa nhóm sản phẩm</span>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="d-flex content__heading--right">
                    <div class="row m-0">
                        <div class="dropdown">
                            <a href="{{ route('groups.index') }}" class="activity" data-name1="KH" data-des="Hủy">
                        ...
                        <div class="content-info">
                            <div class="d-flex align-items-center height-60-mobile">
                                <div class="title-info height-100 py-2 border border-left-0">
                                    <p class="p-0 m-0 required-label margin-left32 text-13-red">Tên nhóm sản phẩm</p>
                                </div>
                            ...
                            <div class="title-info height-100 w-100 py-2 border-bottom scrollbar">
                                @foreach ($products as $item_product)
                                    <div class="d-flex align-items-center py-2">
                                        <input type="checkbox" class="p-0 m-0 margin-left32 text-13-black"
                                            @if ($item_product->group_id == $group->id) checked @endif
                                            value="{{ $item_product->id }}" name="product_id[]">
                                        <p class="p-0 m-0 margin-left32 text-13-black">

    ...
    <div class="content-header-fixed p-0">
        <div class="content__header--inner">
            ...
            <div class="d-flex content__heading--right">
                ...
                <a href="{{ route('content.edit', ['workspace' => $workspacename, 'content' => $content->id]) }}">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="content" class="tab-pane fade">
                                <div class="info-chung">
                                    <div class="row result-filter-content margin-left30">
                                    </div>
                                    <div
                                    ...
                                    <div class="outer container-fluided order_content mt-5" id="print-content">

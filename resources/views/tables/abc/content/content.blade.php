    ...
    <div class="content-header-fixed p-0 border-bottom-0">
        <div class="content__header--inner">
            ...
            <div class="d-flex align-items-center pl-3">
                ...
                <div class="dropdown mx-2 filter-all d-none">
            ...
            <div class="d-flex content__heading--right">
                ...
                <a href="{{ route('content.create', $workspacename) }}" class="mr-3">
                        ...
                        <table id="example2" class="table table-hover">
                            <thead>
                                <tr class="height-30">
                                    ...
                                    <th scope="col" class="border bg-white py-0">
                                        <span class="d-flex">
                                            <a href="#" class="sort-link btn-submit"
                                                data-sort-by="product_name" data-sort-type="DESC">
                                                <button class="btn-sort" type="submit">
                                                    <span class="text-14">Nội dung thu chi</span>
                                                </button>
                                            </a>
                                ...
                                @foreach ($contentGroups as $type => $contents)
                                    <tr>
                                        <td class="text-purble font-weight-bold border-bottom py-1 border-right"
                                            style="font-size: 16px;" colspan="2">Loại nội dung:
                                            {{ $contents->first()->nameType }}</td>
                                    </tr>
                                    @foreach ($contents as $item)
                                        <tr class="position-relative content-info height-30">
                                            <input type="hidden" name="id-content" class="id-content"
                                                id="id-content" value="{{ $item->id }}">
                                            <td class="py-0 text-13-black text-center pl-0 border">
                                                {{ $stt }}
                                            </td>
                                            <td class="px-2 text-13-black py-0 border">
                                                <a

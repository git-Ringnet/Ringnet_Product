<x-navbar :title="$title" activeGroup="" activeName=""></x-navbar>
    ...
    <div class="content-header-fixed p-0 margin-250 border-bottom-0">
        <div class="content__header--inner margin-left32">
            <div class="content__heading--left">
                ...
                <span class="font-weight-bold text-secondary">Điều chỉnh tồn</span>
            </div>
            <div class="d-flex content__heading--right">
                <a href="{{ route('changeInventory.create', $workspacename) }}" class="mr-1">

            ...
            <div class="pl-3 d-flex align-items-center">
                ...
                <div class="dropdown mx-2 filter-all">
                    ...
                    <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="scrollbar">
                            <button class="dropdown-item btndropdown text-13-black" id="btn-warehouseCode"
                                data-button="warehouseCode" type="button">Mã
                                kho
                            </button>
                            <button class="dropdown-item btndropdown text-13-black" id="btn-warehouseName"
                                data-button="warehouseName" type="button">Tên
                                kho
                            </button>
                    ...
                    <div class="card">
                        ...
                        <div class="outer2">
                            <table id="example2" class="table table-hover">
                                <thead>
                                    <tr class="height-30">
                                        <th scope="col" class="bg-white pl-2 border-bottom py-0" style="width: 10%;">
                                            <span class="d-flex">
                                        ...
                                        <th scope="col" class="bg-white border-bottom py-0">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link btn-submit"
                                        ...
                                        <th scope="col" class="bg-white border-bottom py-0" style="width: 14%;">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link btn-submit"
                                ...
                                <tbody class="tbody-warehouse">
                                    @foreach ($wareHouse as $item)
                                        <tr class="position-relative warehouse-info height-30"
                                            ...
                                            <td class="py-0 text-13-black border-bottom border-top-0 pl-2">
                                                {{ $item->warehouse_code }}
                                            </td>

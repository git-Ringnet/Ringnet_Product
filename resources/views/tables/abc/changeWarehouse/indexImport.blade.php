        ...
        <div class="content__header--inner">
            ...
            <div class="pl-3 d-flex align-items-center">
                ...
                <div class="dropdown mx-2 filter-all">
                    ...
                    <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="scrollbar">
                            ...
                            <button class="dropdown-item btndropdown text-13-black" id="btn-return_code"
                                data-button="return_code" type="button">Mã
                                phiếu
                            </button>
                            <button class="dropdown-item btndropdown text-13-black" id="btn-users" data-button="users"
                                type="button">Người lập
                            </button>
                            <button class="dropdown-item btndropdown text-13-black" id="btn-wh_from"
                                data-button="wh_from" type="button">Từ kho
                            </button>
                            <button class="dropdown-item btndropdown text-13-black" id="btn-wh_to" data-button="wh_to"
                                type="button">Đến kho
                            </button>
                    ...
                    <x-filter-text name="wh_from" title="Từ kho" />
                    <x-filter-text name="wh_to" title="Đến kho" />
            ...
            <div class="d-flex content__heading--right">
                ...
                <div class="row m-0">
                    <a href="{{ route('importChangeWarehouse.create', $workspacename) }}" class="mr-3">
                ...
                <div class="card">
                    ...
                    <div class="outer2" id="print-transferWH">
                        <table id="example2" class="table table-hover">
                            <thead>
                                <tr class="height-30">
                                    <th scope="col" class="border-top-0 bg-white py-0 border-bottom">
                                        <span class="d-flex">
                                            <a href="#" class="sort-link btn-submit"
                                                data-sort-by="product_code" data-sort-type="DESC">
                                                <button class="btn-sort" type="submit">
                                                    <span class="text-14">Ngày lập phiếu
                                                    </span>
                                                </button>
                                            </a>
                                    ...
                                    <tr class="position-relative product-info height-30"
                                        ...
                                        <td class="py-0 text-13-black border-bottom border-top-0">
                                            @if ($item->getFromWarehouse)
                                                {{ $item->getFromWarehouse->warehouse_name }}
                                            @endif
                                        </td>
                                        <td class="py-0 text-13-black border-bottom border-top-0">
                                            @if ($item->getToWarehouse)
                                                {{ $item->getToWarehouse->warehouse_name }}
                                            @endif
                                        </td>
                                        <td class="py-0 text-13-black border-bottom border-top-0">
                                            @if ($item->getUser)
...
<script type="text/javascript">
    ...
    $(document).on('click', '.btn-submit', function(e) {
        ...
        var formData = {
            ...
            wh_from: getData('#wh_from', this), // Từ kho
            wh_to: getData('#wh_to', this), // Đến kho

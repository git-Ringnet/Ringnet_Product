    ...
    <div class="content-header-fixed p-0 border-bottom-0">
        <div class="content__header--inner">
            {{-- <div class="content__heading--left opacity-0">
                ...
                <span class="font-weight-bold text-secondary">Chuyển tiền nội bộ</span>
            </div> --}}
            ...
            <div class="d-flex content__heading--right">
                <div class="row m-0">
                    ...
                    <button class="mx-1 d-flex align-items-center btn-primary rounded"
                        onclick="printContentCustom('printContent', 'print-changeFund')">In
                        trang
                    </button>
                ...
                <div class="row m-0">
                    <a href="{{ route('changeFund.create', $workspacename) }}" class="mr-3">
    ...
    <div class="container-fluided">
        ...
        <div class="row p-0 m-0">
            <div class="col-12 p-0 m-0">
                <div class="card">
                    <!-- /.card-header -->
                    <div class="outer2" id="print-changeFund">

                    ...
                    <div
                        ...
                        <span class="mx-1 text-13" style="flex: 2;">
                            <input type="text" placeholder="Chọn thông tin" name="code_return"
                                ...
                                value="{{ $returnExport->code_return }}" readonly>
                        </span>
                    </div>
                </div>
                <div class="d-flex w-100">
                                ...
                                <table class="table table-hover bg-white rounded">
                                    <thead>
                                        <tr style="height:44px;">
                                            ...
                                            <th class="border-right p-0 px-2 text-13 text-left" style="width:15%;">Tên
                                                sản
                                                phẩm</th>
                                            <th class="border-right p-0 px-2 text-13 text-left" style="width:7%;">Đơn
                                                vị
                                            </th>
                            ...
                            <td class="bg-white align-top text-13-black border-top-0 border-bottom border-right">
                                <div>
                                    <input type="text" required=""
                                        ...
                                        name="product_price[]" value="{{ number_format($item->price_export) }}"
                                        readonly>
                                </div>
                            </td>
                            <td
                                ...
                                <div>
                                    <input type="text"
                                        ...
                                        name="discount_input[]" value="{{ number_format($promotionValue) }}"
                                        readonly>
                                </div>

                                ...
                                @foreach ($numberQuote as $quote_value)
                                    <li class="p-2 align-items-center text-wrap"
                                        ...
                                        <a href="#" title="" style="flex:2" data-name1="GH"
                                            ...
                                            <span class="text-13-black">{{ $quote_value->code_delivery }}</span></span>
                                        </a>
            ...
            <div class="d-flex w-100">
                ...
                <div
                    ...
                    <input type="hidden" class="represent_guest_id" name="represent_guest_id" autocomplete="off"
                        value="{{ $returnExport->represent_guest_id }}">
                    <div id="myUL7" class="bg-white position-absolute rounded shadow p-1 list-guest z-index-block"
                        style="z-index: 99;">
                        <div class="p-1">
                            <div class="position-relative">
                        ...
                        <a type="button" class="d-flex align-items-center p-2 position-sticky addRepresentNew mt-2"
                            ...
                            <span class="text-13-black pl-3 pt-1" style="font-weight: 600 !important;">Thêm người đại
                                diện</span>
                        </a>
                    </div>
                </div>

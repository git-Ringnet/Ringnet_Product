<x-navbar :title="$title" activeGroup="manageProfess" activeName="returnexport"></x-navbar>
        ...
        <div class="content__header--inner">
            ...
            <div class="pl-3 d-flex align-items-center">
                ...
                <div class="dropdown mx-2 filter-all">
                    ...
                    <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="dropdownMenuButton" style="z-index:">
                        ...
                        <div class="scrollbar">
                            ...
                            <button class="dropdown-item btndropdown text-13-black" id="btn-quotenumber"
                                data-button="quotenumber" type="button">
                                Phiếu bán hàng
                            </button>
                            ...
                            <button class="dropdown-item btndropdown text-13-black" id="btn-return_content"
                                data-button="return_content" type="button">
                                Nội dung trả hàng
                            </button>
                        </div>
                    </div>
                    ...
                    <x-filter-text name="quotenumber" title="Phiếu bán hàng" />
            ...
            <div class="d-flex content__heading--right">
                ...
                <div class="row m-0">
                    <a href="{{ route('returnExport.create', $workspacename) }}" class="user_flow mr-3"
            ...
            <div class="container-fluided">
                ...
                <div class="row p-0 m-0">
                    <div class="col-12 p-0">
                        <div class="card ">
                            <!-- /.card-header -->
                            <div class="content-info position-relative outer2 text-nowrap" id="print-returnE">
                                        ...
                                        <tr class="height-30 border-custom">
                                            ...
                                            <th scope="col" class="border-bottom py-0">
                                                <span class="d-flex justify-content-start">
                                                    <a href="#" class="sort-link btn-submit"
                                                        data-sort-by="code_delivery" data-sort-type="DESC">
                                                        <button class="btn-sort text-14" type="submit">Phiếu bán
                                                            hàng</button>
                                                    </a>
                                                    <div class="icon" id="icon-code_delivery"></div>
                                                </span>
                                                ...
                                                <span class="d-flex justify-content-start">
                                                    <a href="#" class="sort-link btn-submit"
                                                        data-sort-by="shipping_unit" data-sort-type="DESC"><button
                                                            class="btn-sort text-14" type="submit">Đơn vị vận
                                                            chuyển</button>
                                                    </a>
                                                ...
                                                <span class="d-flex justify-content-end">
                                                    <a href="#" class="sort-link btn-submit"
                                                        data-sort-by="delivery_charges" data-sort-type="DESC"><button
                                                            class="btn-sort text-14" type="submit">Phí vận
                                                            chuyển</button>
                                                    </a>
                                                ...
                                                <span class="d-flex justify-content-end">
                                                    <a href="#" class="sort-link btn-submit"
                                                        data-sort-by="total_tax" data-sort-type="DESC"><button
                                                            class="btn-sort text-14" type="submit">Nội dung trả
                                                            hàng</button>
                                                    </a>
                                                        ...
                                                        <a href="#">
                                                            <div class="m-0 mx-2 rounded">
                                                                <form
                                                                    ...
                                                                    action="{{ route('returnExport.destroy', ['workspace' => $workspacename, 'returnExport' => $item->id]) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
...
<script type="text/javascript">
    $(document).on('click', '.btn-submit', function(e) {
        ...
        var formData = {
            ...
            quotenumber: getData('#quotenumber', this), // Phiếu bán hàng
            date: retrieveDateData(this, 'date'), // Ngày trả hàng
            customers: getData('#customers', this), // Khách hàng
            users: getStatusData(this, 'users'), // Nhân viên sale
            status: getStatusData(this, 'status'), // Trạng thái
            return_content: getData('#return_content', this), // Nội dung trả hàng

...
<div class="content-wrapper" style="background: none;">
    ...
    <div class="content-wrapper1 px-0 py-0 editGuest" style="margin-top: 7.5rem;">
                                ...
                                <div class="row mr-0">
                                    <div class="col-md-5 d-flex align-items-center">
                                        <div class="dropdown mx-2">
                                            <button class="btn-filter_searh" data-toggle="dropdown" style="width: 106px;">
                                                <span class="text-btnIner">Đơn báo giá</span>
                                                <span>
                                            ...
                                            <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <div class="scrollbar">
                                                    ...
                                                    <button class="dropdown-item btndropdown text-13-black" id="btn-code" data-button="code"
                                                        type="button">Đơn mua hàng
                                                    </button>
                                                    <button class="dropdown-item btndropdown text-13-black" id="btn-name" data-button="name"
                                                        type="button">Hóa đơn mua hàng
                                                    </button>
                                                    <button class="dropdown-item btndropdown text-13-black" id="btn-inventory"
                                                        data-button="inventory" type="button">
                                                        Thanh toán mua hàng

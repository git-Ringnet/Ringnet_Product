                            ...
                            <div class="dropdown-menu" id="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <div class="scrollbar">
                                    <button class="dropdown-item btndropdown" id="btn-code" data-button="code"
                                        type="button">Mã
                                        hàng hóa</button>
                                    <button class="dropdown-item btndropdown" id="btn-name" data-button="name"
                                        type="button">Tên
                                        hàng hóa
                                    </button>
...
<div class="content-wrapper py-0 pl-0 pr-2" style="min-height: 466px;">
    <!-- Main content -->
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-hover">
                                <thead class="sticky-head">
                                    <tr>
                                        <th class="border-top-0 my-0 py-2" style="width: 1%;"></th>
                                            ...
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="id"
                                                    ...
                                                    <button class="btn-sort" type="submit"><span
                                                            class="text-secondary text-nav">Mã hàng hóa
                                                        </span></button>
                                                </a>
                                            ...
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="export_code"
                                                    ...
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Tên hàng hóa</span>
                                                    </button>
                                                </a>
                                        ...
                                        <th scope="col" class="border-top-0 bg-white my-0 py-2">
                                            <span class="d-flex">
                                                <a href="#" class="sort-link" data-sort-by="guest_receiver"
                                                    data-sort-type="">
                                                    <button class="btn-sort" type="submit">
                                                        <span class="text-secondary text-nav">Số lượng tồn</span>
                                                    </button>
                                                </a>
                                ...
                                <tbody>
                                    @foreach ($product as $item)
                                        <tr class="position-relative" onclick="handleRowClick('checkbox', event);">
                                            ...
                                            <td class="pl-0 py-2">
                                                <input type="checkbox" class="p-0 m-0" name="ids[]" id="checkbox"

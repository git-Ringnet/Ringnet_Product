...
<div class="content-wrapper m-0 min-height--none">
    ...
    <div class="content margin-top-fixed5">
        <!-- Main content -->
                                        ...
                                        @foreach ($product as $item)
                                            <tr class="position-relative" onclick="handleRowClick('checkbox', event);">
                                                <td>
                                                    ...
                                                    <input type="checkbox" class="p-0 m-0 checkall-btn" name="ids[]" id="checkbox"
                                                        value="" onclick="event.stopPropagation();">
                                                </td>
                                                    ...
                                                    <div class="d-flex w-100">
                                                        ...
                                                        <div class="m-0 mx-2 rounded">
                                                            <form onclick="return confirm('Bạn có chắc chắn muốn xóa?')"
                                                                action="http://127.0.0.1:8000/123/detailExport/5"
                                                                method="POST" class="d-inline">
                                                                <input type="hidden" name="_token"
                                                                    value="2HpBp2uUmNlPK18jSCdyiDlsQ3OQfXL0bqDSIj8v"

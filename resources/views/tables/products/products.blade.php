                ...
                <div class="col-12 col-md-12 mr-0">
                    <div class="row d-flex">
                        ...
                        <div class="dropdown mx-2 d-none">
                            ...
                            <x-filter-checkbox :dataa='$product' button="products" name="code" title="Mã hàng hóa"
                        ...
                        <table id="example2" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="border-top-0 bg-white pl-0 border-bottom" style="width: 10%;">
                                        <span class="d-flex">
                                    ...
                                    <th scope="col" class="border-top-0 bg-white border-bottom" style="width: 14%;">
                                        <span class="d-flex">
                                            <a href="#" class="sort-link btn-submit"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-submit').click(function(event) {
            ...
            if ($(this).data('button-name') === 'code') {
                $('.ks-cboxtags-code input[type="checkbox"]').each(function() {
                    const value = $(this).val();
                    if ($(this).is(':checked') && idCode.indexOf(value) === -1) {
                        idCode.push(value);
                    } else if (!$(this).is(':checked')) {
                        const index = idCode.indexOf(value);
                        if (index !== -1) {
                            idCode.splice(index, 1);
                        }
                    }
                });
            }

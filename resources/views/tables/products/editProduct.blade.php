        ...
        <section class="content-header mt-4">
            <div class="container-fluided">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#SNModal"
                            ...
                            <table id="table_SNS">
                                ...
                                <tbody>
                                    @if ($product->getSerialNumber)
                                        @foreach ($product->getSerialNumber as $item)
                                            <tr>
                                                <td><input type="checkbox"></td>
                                                <td>1</td>
                                                <td><input class="form-control w-25" type="text" name="seri[]" value="{{$item->serinumber}}">
                                                </td>
